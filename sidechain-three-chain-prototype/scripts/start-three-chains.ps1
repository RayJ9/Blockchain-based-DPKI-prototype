...
if ($Clean) {
    ...
    if (Test-Path -LiteralPath $RuntimeRoot) {
        ...
        if (-not $resolvedRuntime.StartsWith($resolvedPrototype, [System.StringComparison]::OrdinalIgnoreCase)) {
            throw "Refusing to clean runtime outside $resolvedPrototype"
        }
