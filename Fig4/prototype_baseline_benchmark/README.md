# Fig4 Prototype Baseline Benchmark

This directory contains the Fig4-only overhead benchmark. It does not modify the
Fig7-Fig10 simulation or plotting scripts.
...
The Fig4 folder keeps one retained final overhead run for table regeneration:
