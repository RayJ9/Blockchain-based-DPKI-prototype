...
import (
	...
	_ "code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/secp256k1"
	_ "code.corp.bcollie.net/omnilink/omnilink-base/system/dapp/coins/types"
...
func TestResetDatadir(t *testing.T) {
	cfg, _ := types.InitCfg("../cmd/omnilink/omnilink.toml")
...
func TestExecBlock(t *testing.T) {
	...
	str = strings.Replace(str, "Title=\"local\"", "Title=\"omnilink\"", 1)
	str += "\n[fork.sub.coins]\nEnable=0\nForkFriendExecer=0"
	cfg := types.NewOmnilinkConfig(types.MergeCfg(types.ReadFile("../cmd/omnilink/omnilink.system.fork.toml"), str))
	client := &testClient{}
...
func TestReportErrEventToFront(t *testing.T) {
	...
	client.On("GetConfig").Return(&types.OmnilinkConfig{})
