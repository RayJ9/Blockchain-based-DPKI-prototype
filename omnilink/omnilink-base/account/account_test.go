...
import (
	...
	_ "code.corp.bcollie.net/omnilink/omnilink-base/system/address" //init address
...
func TestGetExecBalance2(t *testing.T) {
	accCoin := NewCoinsAccount(types.NewOmnilinkConfig(types.GetDefaultCfgstring()))
	key := "mavl-coins-bty-exec-16htvcBNSEA7fZhAdLJphDwQRQJaHpyHTp:1JmFaA6unrCFYEWPGRi7uuXY1KthTJxJEP"
...
func TestAccountKey(t *testing.T) {
	...
	acc := NewCoinsAccount(types.NewOmnilinkConfig(types.GetDefaultCfgstring()))
