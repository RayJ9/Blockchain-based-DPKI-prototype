...
func NewCoinsAccount(cfg *types.OmnilinkConfig) *DB {
	//缺省"coins"，支持coinsx扩展
...
// NewAccountDB 新建DB账户
func NewAccountDB(cfg *types.OmnilinkConfig, execer string, symbol string, db dbm.KV) (*DB, error) {
...
func newAccountDB(cfg *types.OmnilinkConfig, prefix string) *DB {
	acc := &DB{cfg: cfg}
