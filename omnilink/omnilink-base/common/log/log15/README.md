...
# log15 [![godoc reference](https://godoc.org/code.corp.bcollie.net/omnilink/omnilink-base/common/log/log15?status.png)](https://godoc.org/code.corp.bcollie.net/omnilink/omnilink-base/common/log/log15) [![Build Status](https://travis-ci.org/inconshreveable/log15.svg?branch=master)](https://travis-ci.org/inconshreveable/log15)
...
```go
import log "code.corp.bcollie.net/omnilink/omnilink-base/common/log/log15"
```
