...
func TestQueueProtocolAPI(t *testing.T) {
	...
	q.SetConfig(types.NewOmnilinkConfig(types.GetDefaultCfgstring()))
...
func testGetAccountsJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetAccounts", &types.ReqNil{}, &res)
	if err != nil {
...
func testDumpPrivkeyJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.DumpPrivkey", &types.ReqString{}, &res)
	if err != nil {
...
func testDumpPrivkeysFileJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.DumpPrivkeysFile", &types.ReqPrivkeysFile{}, &res)
	if err != nil {
...
func testImportPrivkeysFileJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res rpctypes.Reply
	err := rpc.newRPCCtx("Omnilink.ImportPrivkeysFile", &types.ReqPrivkeysFile{}, &res)
	if err != nil {
...
func testGetWalletStatusJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetWalletStatus", &types.ReqNil{}, &res)
	if err != nil {
...
func testGetNetInfoJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetNetInfo",
...
func testIsSyncJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRPCCtx("Omnilink.IsSync",
		nil, &res)
	if err != nil {
...
func testIsNtpClockSyncJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRPCCtx("Omnilink.IsNtpClockSync",
		nil, &res)
	if err != nil {
...
func testGetPeerInfoJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetPeerInfo",
...
func testGenSeedJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GenSeed",
		params, &res)
	if err != nil {
...
func testGetLastMemPoolJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetLastMemPool",
		nil, &res)
	if err != nil {
...
func testGetProperFeeJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetProperFee",
		nil, &res)
	if err != nil {
...
func testGetMempoolJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res rpctypes.ReplyTxList
	err := rpc.newRPCCtx("Omnilink.GetMempool",
		nil, &res)
	if err != nil {
...
func testGetLastHeaderJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetLastHeader",
		nil, &res)
	if err != nil {
...
func testGetHeadersCmdJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetHeaders",
		&params, &res)
	if err != nil {
...
func testGetBlockOverviewJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetBlockOverview",
		params, &res)
	if err != nil {
...
func testGetBlocksJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetBlocks",
		params, &res)
	if err != nil {
...
func testGetBlockHashJSONRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRPCCtx("Omnilink.GetBlockHash",
		&params, &res)
	if err != nil {
...
func testVersionGRPC(t *testing.T, rpc *mockGRPCSystem) {
	...
	assert.Equal(t, version.GetVersion(), rpc.ctx.Res.(*types.VersionInfo).Omnilink)
}
...
func TestGetMainSeq(t *testing.T) {
	...
	defer chain.Close()
	net.SetConfig(types.NewOmnilinkConfig(types.GetDefaultCfgstring()))
