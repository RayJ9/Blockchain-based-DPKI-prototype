...
import (
	queue "code.corp.bcollie.net/omnilink/omnilink-base/queue"
...
func (_m *QueueProtocolAPI) GetConfig() *types.OmnilinkConfig {
	ret := _m.Called()

	var r0 *types.OmnilinkConfig
	if rf, ok := ret.Get(0).(func() *types.OmnilinkConfig); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.OmnilinkConfig)
		}
	}
