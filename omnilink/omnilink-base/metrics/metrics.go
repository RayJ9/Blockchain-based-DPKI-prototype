...
import (
	...
	omnilinklog "code.corp.bcollie.net/omnilink/omnilink-base/common/log/log15"
	"code.corp.bcollie.net/omnilink/omnilink-base/metrics/influxdb"
...
var (
	log = omnilinklog.New("module", "omnilink metrics")
)

//StartMetrics 根据配置文件相关参数启动m
func StartMetrics(cfg *types.OmnilinkConfig) {
