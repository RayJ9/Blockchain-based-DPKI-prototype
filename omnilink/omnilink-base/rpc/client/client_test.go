...
import (
	...
	slog "code.corp.bcollie.net/omnilink/omnilink-base/common/log"
	"code.corp.bcollie.net/omnilink/omnilink-base/pluginmgr"
	qmock "code.corp.bcollie.net/omnilink/omnilink-base/queue/mocks"
...
func Init(cfg *types.OmnilinkConfig) {
