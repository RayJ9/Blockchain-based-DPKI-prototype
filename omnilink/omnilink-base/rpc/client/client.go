...
// Package rpc omnilink RPC模块包含JSONRpc以及grpc
package client
...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/btcscript"
...
// GetWalletRecoverAddr get wallet recover omnilink address
