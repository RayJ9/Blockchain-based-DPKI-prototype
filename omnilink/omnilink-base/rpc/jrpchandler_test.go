...
func newTestOmnilink(api client.QueueProtocolAPI) *Omnilink {
...
func TestOmnilink_CreateRawTransaction(t *testing.T) {
	api := new(mocks.QueueProtocolAPI)
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api.On("GetConfig", mock.Anything).Return(cfg, nil)
	testOmnilink := newTestOmnilink(api)
	var testResult interface{}
	err := testOmnilink.CreateRawTransaction(nil, &testResult)
	...
	err = testOmnilink.CreateRawTransaction(tx, &testResult)
	assert.NotNil(t, testResult)
	assert.Nil(t, err)
}

func TestOmnilink_ReWriteRawTx(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	...
	var testResult interface{}
	err := testOmnilink.ReWriteRawTx(reTx, &testResult)
	assert.Nil(t, err)
	assert.NotNil(t, testResult)
...
func TestOmnilink_CreateTxGroup(t *testing.T) {
	api := new(mocks.QueueProtocolAPI)
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.CreateRawTxGroup(nil, &testResult)
	assert.Nil(t, testResult)
	assert.NotNil(t, err)
	...
	err = testOmnilink.CreateRawTxGroup(txs, &testResult)
	assert.Nil(t, err)
...
func TestOmnilink_SendTransaction(t *testing.T) {
	//if types.IsPara() {
	//	t.Skip()
	//	return
	//}
	...
	err := testOmnilink.SendTransaction(data, &testResult)
	t.Log(err)
...
func TestOmnilink_SendTransactions(t *testing.T) {
	...
	err := testOmnilink.SendTransactions(data, &testResult)
	require.Nil(t, err)
...
func TestOmnilink_SendTransactionSync(t *testing.T) {
	api := new(mocks.QueueProtocolAPI)
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api.On("GetConfig", mock.Anything).Return(cfg)
	tx := &types.Transaction{}
	...
	err := testOmnilink.SendTransactionSync(data, &testResult)
	t.Log(err)
	assert.Equal(t, common.ToHex(hash), testResult.(string))
	assert.Nil(t, err)
}

func TestOmnilink_GetHexTxByHash(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	err := testOmnilink.GetHexTxByHash(data, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_QueryTransaction(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	api.On("QueryTx", &types.ReqHash{Hash: []byte("")}).Return(nil, errors.New("error value"))
	...
	err := testOmnilink.QueryTransaction(data, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_QueryTransactionOk(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	data := rpctypes.QueryParm{
		Hash: "",
	}
...
func TestOmnilink_GetBlocks(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	err := testOmnilink.GetBlocks(data, &testResult)
	t.Log(err)
...
func TestOmnilink_GetLastHeader(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	var testResult interface{}
	data := &types.ReqNil{}
	err := testOmnilink.GetLastHeader(data, &testResult)
	t.Log(err)
	assert.NotNil(t, &testResult)
	assert.NoError(t, err)
...
func TestOmnilink_GetTxByAddr(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	data := types.ReqAddr{}
	err := testOmnilink.GetTxByAddr(&data, &testResult)
	t.Log(err)
	assert.NotNil(t, testResult)
	assert.NoError(t, err)
...
func TestOmnilink_GetTxByHashes(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetTxByHashes(data, &testResult)
	t.Log(err)
	assert.NotNil(t, testResult)
	assert.NoError(t, err)
...
func TestOmnilink_GetMempool(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetMempool(data, &testResult)
	t.Log(err)
	assert.NotNil(t, testResult)
	assert.NoError(t, err)
...
func TestOmnilink_GetAccountsV2(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	err := testOmnilink.GetAccountsV2(nil, &testResult)
	t.Log(err)
	assert.NotNil(t, testResult)
	assert.NoError(t, err)
}

func TestOmnilink_GetAccounts(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetAccounts(data, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_NewAccount(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	err := testOmnilink.NewAccount(&types.ReqNewAccount{}, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
	mock.AssertExpectationsForObjects(t, api)
...
func TestOmnilink_GetAccount(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	err := testOmnilink.GetAccount(&types.ReqGetAccount{}, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
	mock.AssertExpectationsForObjects(t, api)
}
func TestOmnilink_WalletTxList(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.WalletTxList(actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_ImportPrivkey(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.ImportPrivkey(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_SendToAddress(t *testing.T) {
	//if types.IsPara() {
	//	t.Skip()
	//	return
	//}
	...
	err := testOmnilink.SendToAddress(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_SetTxFee(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.SetTxFee(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_SetLabl(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.SetLabl(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_MergeBalance(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.MergeBalance(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_SetPasswd(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.SetPasswd(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_Lock(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	actual := types.ReqNil{}
	err := testOmnilink.Lock(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_UnLock(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.UnLock(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetPeerInfo(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetPeerInfo(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetPeerInfoOk(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	_ = testOmnilink.GetPeerInfo(&in, &testResult)
	assert.Equal(t, testResult.(*rpctypes.PeerList).Peers[0].Addr, peerlist.Peers[0].Addr)
}

func TestOmnilink_GetHeaders(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetHeaders(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetHeadersOk(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
...
func TestOmnilink_GetLastMemPool(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	actual := types.ReqNil{}
	err := testOmnilink.GetLastMemPool(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetProperFee(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	err := testOmnilink.GetProperFee(&expected, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetBlockOverview(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetBlockOverview(actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetBlockOverviewOk(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
...
func TestOmnilink_GetAddrOverview(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetAddrOverview(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetBlockHash(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	actual := types.ReqInt{}
	err := testOmnilink.GetBlockHash(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GenSeed(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GenSeed(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_SaveSeed(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.SaveSeed(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetSeed(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetSeed(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_GetWalletStatus(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	var testResult interface{}
	actual := types.ReqNil{}
	err := testOmnilink.GetWalletStatus(&actual, &testResult)
	t.Log(err)
	assert.Equal(t, nil, testResult)
	assert.NotNil(t, err)
...
func TestOmnilink_Version(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	var testResult interface{}
	in := &types.ReqNil{}
	ver := &types.VersionInfo{Omnilink: "6.0.2"}
	api.On("Version", mock.Anything).Return(ver, nil)
	err := testOmnilink.Version(in, &testResult)
	t.Log(err)
	t.Log(testResult)
...
func TestOmnilink_GetTimeStatus(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
	var result interface{}
	err := client.GetTimeStatus(&types.ReqNil{}, &result)
	assert.Nil(t, err)
}

func TestOmnilink_GetServerTime(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetLastBlockSequence(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetBlockSequences(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetBlockByHashes(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_CreateTransaction(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetExecBalance(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetBalance(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_CreateNoBalanceTransaction(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	omnilink := newTestOmnilink(api)
	api.On("GetProperFee", mock.Anything).Return(&types.ReplyProperFee{ProperFee: 1000000}, nil)
	var result string
	err := omnilink.CreateNoBalanceTransaction(&types.NoBalanceTx{TxHex: "0a05636f696e73122c18010a281080c2d72f222131477444795771577233553637656a7663776d333867396e7a6e7a434b58434b7120a08d0630a696c0b3f78dd9ec083a2131477444795771577233553637656a7663776d333867396e7a6e7a434b58434b71"}, &result)
	assert.NoError(t, err)
}

func TestOmnilink_CreateNoBalanceTxs(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	omnilink := newTestOmnilink(api)
	api.On("GetProperFee", mock.Anything).Return(&types.ReplyProperFee{ProperFee: 1000000}, nil)
	var result string
	err := omnilink.CreateNoBlanaceTxs(&types.NoBalanceTxs{TxHexs: []string{"0a05746f6b656e12413804223d0a0443434e5910a09c011a0d74657374207472616e73666572222231333559774e715367694551787577586650626d526d48325935334564673864343820a08d0630969a9fe6c4b9c7ba5d3a2231333559774e715367694551787577586650626d526d483259353345646738643438", "0a05746f6b656e12413804223d0a0443434e5910b0ea011a0d74657374207472616e73666572222231333559774e715367694551787577586650626d526d48325935334564673864343820a08d0630bca0a2dbc0f182e06f3a2231333559774e715367694551787577586650626d526d483259353345646738643438"}}, &result)
	assert.NoError(t, err)
}

func TestOmnilink_ExecWallet(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_Query(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_DumpPrivkey(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_DumpPrivkeysFile(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_ImportPrivkeysFile(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetTotalCoins(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetFatalFailure(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_DecodeRawTransaction(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_CloseQueue(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_AddSeqCallBack(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_ListSeqCallBack(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetSeqCallBackLastNum(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_ConvertExectoAddr(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func queryTotalFee(client *Omnilink, req *types.LocalDBGet, t *testing.T) int64 {
	var testResult interface{}
...
func TestOmnilink_QueryTotalFee(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetSequenceByHash(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetBlockBySeq(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetParaTxByTitle(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_LoadParaTxByTitle(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_GetParaTxByHeight(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_QueryChain(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_convertParaTxDetails(t *testing.T) {
...
func TestOmnilink_convertHeader(t *testing.T) {
	var header types.Header
...
func TestOmnilink_ChainID(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	testOmnilink := newTestOmnilink(api)
	...
	err := testOmnilink.GetChainID(in, &testResult)
	assert.Equal(t, nil, err)
	assert.Equal(t, int32(33), testResult.(*rpctypes.ChainIDInfo).ChainID)
}

func TestOmnilink_GetCryptoList(t *testing.T) {
	omnilink := &Omnilink{cli: rpcclient.ChannelClient{}}
	var result interface{}
	err := omnilink.GetCryptoList(&types.ReqNil{}, &result)
	assert.Nil(t, err)
}

func TestOmnilink_GetAddressDrivers(t *testing.T) {
	omnilink := &Omnilink{cli: rpcclient.ChannelClient{}}
	var result interface{}
	err := omnilink.GetAddressDrivers(&types.ReqNil{}, &result)
	assert.Nil(t, err)
	assert.True(t, len(result.(*types.AddressDrivers).GetDrivers()) > 0)
}

func TestOmnilink_SendDelayTransaction(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	client := newTestOmnilink(api)
...
func TestOmnilink_WalletRecoverScript(t *testing.T) {

	omnilink := &Omnilink{cli: rpcclient.ChannelClient{}}
	var result interface{}
	err := omnilink.GetWalletRecoverAddress(nil, &result)
	require.Equal(t, types.ErrInvalidParam, err)
	err = omnilink.SignWalletRecoverTx(nil, &result)
	require.Equal(t, types.ErrInvalidParam, err)
}

func TestOmnilink_GetChainConfig(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
...
func TestOmnilink_AddBlacklist(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	var testResult interface{}
	err := testOmnilink.AddBlacklist(&peer, &testResult)
	assert.Nil(t, err)
...
func TestOmnilink_DelBlacklist(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	var testResult interface{}
	err := testOmnilink.DelBlacklist(&peer, &testResult)
	assert.Nil(t, err)
	reply, ok := testResult.(*rpctypes.Reply)
	assert.True(t, ok)
...
func TestOmnilink_ShowBlacklist(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	testOmnilink := newTestOmnilink(api)
	var testResult interface{}
	err := testOmnilink.ShowBlacklist(&types.ReqNil{}, &testResult)
	assert.Nil(t, err)
...
func TestOmnilink_DialPeer(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	...
	testOmnilink := newTestOmnilink(api)
	var testResult interface{}
	err := testOmnilink.DialPeer(&types.SetPeer{}, &testResult)
	assert.Nil(t, err)
	_, ok := testResult.(*rpctypes.Reply)
	assert.True(t, ok)
}

func TestOmnilink_ClosePeer(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
	api := new(mocks.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(cfg)
	expected := &types.Reply{}
	...
	testOmnilink := newTestOmnilink(api)
	var testResult interface{}
	err := testOmnilink.ClosePeer(&types.SetPeer{}, &testResult)
	assert.Nil(t, err)
	_, ok := testResult.(*rpctypes.Reply)
	assert.True(t, ok)
}
