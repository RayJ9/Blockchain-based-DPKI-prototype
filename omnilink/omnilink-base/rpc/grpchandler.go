...
import (
	...
	pb "code.corp.bcollie.net/omnilink/omnilink-base/types"
...
// GetPendingSize return last mempool pending size
func (g *Grpc) GetPendingSize(ctx context.Context, in *pb.ReqNil) (*pb.ReplyPendingSize, error) {
	return g.cli.GetPendingSize()
}
...
// SubEvent 订阅消息推送服务
func (g *Grpc) SubEvent(in *pb.ReqSubscribe, resp pb.Omnilink_SubEventServer) error {
