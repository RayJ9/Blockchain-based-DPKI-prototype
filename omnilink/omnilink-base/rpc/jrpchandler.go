...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/wallet/bipwallet"
...
func (c *Omnilink) CreateRawTransaction(in *rpctypes.CreateTx, result *interface{}) error {
	if in == nil {
...
func (c *Omnilink) ReWriteRawTx(in *rpctypes.ReWriteRawTx, result *interface{}) error {
...
func (c *Omnilink) CreateRawTxGroup(in *types.CreateTransactionGroup, result *interface{}) error {
...
func (c *Omnilink) CreateNoBlanaceTxs(in *types.NoBalanceTxs, result *string) error {
...
func (c *Omnilink) CreateNoBalanceTransaction(in *types.NoBalanceTx, result *string) error {
...
func (c *Omnilink) SendTransaction(in rpctypes.RawParm, result *interface{}) error {
...
func (c *Omnilink) SendTransactions(in rpctypes.ReqStrings, result *interface{}) error {
...
func (c *Omnilink) SendTransactionSync(in rpctypes.RawParm, result *interface{}) error {
...
func (c *Omnilink) GetHexTxByHash(in rpctypes.QueryParm, result *interface{}) error {
...
func (c *Omnilink) QueryTransaction(in rpctypes.QueryParm, result *interface{}) error {
	var data types.ReqHash
	hash, err := common.FromHex(in.Hash)
	if err != nil {
		return err
...
func (c *Omnilink) GetBlocks(in rpctypes.BlockParam, result *interface{}) error {
...
func (c *Omnilink) GetLastHeader(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetTxByAddr(in *types.ReqAddr, result *interface{}) error {
...
*/
func (c *Omnilink) GetTxByHashes(in rpctypes.ReqHashes, result *interface{}) error {
...
func (c *Omnilink) GetMempool(in *types.ReqGetMempool, result *interface{}) error {
...
func (c *Omnilink) GetAccountsV2(in *types.ReqNil, result *interface{}) error {
	req := &types.ReqAccountList{WithoutBalance: false}
	return c.GetAccounts(req, result)
}

// GetAccounts get accounts
func (c *Omnilink) GetAccounts(in *types.ReqAccountList, result *interface{}) error {
...
func (c *Omnilink) NewAccount(in *types.ReqNewAccount, result *interface{}) error {
...
func (c *Omnilink) NewRandAccount(in *types.GenSeedLang, result *interface{}) error {
...
func (c *Omnilink) PubKeyToAddr(in *types.ReqString, result *interface{}) error {
...
func (c *Omnilink) WalletTxList(in rpctypes.ReqWalletTransactionList, result *interface{}) error {
...
func (c *Omnilink) ImportPrivkey(in *types.ReqWalletImportPrivkey, result *interface{}) error {
...
func (c *Omnilink) SendToAddress(in *types.ReqWalletSendToAddress, result *interface{}) error {
...
// SetTxFee set tx fee
func (c *Omnilink) SetTxFee(in *types.ReqWalletSetFee, result *interface{}) error {
...
// SetLabl set lable
func (c *Omnilink) SetLabl(in *types.ReqWalletSetLabel, result *interface{}) error {
...
func (c *Omnilink) GetAccount(in *types.ReqGetAccount, result *interface{}) error {
...
func (c *Omnilink) MergeBalance(in *types.ReqWalletMergeBalance, result *interface{}) error {
...
func (c *Omnilink) SetPasswd(in *types.ReqWalletSetPasswd, result *interface{}) error {
...
// Lock wallet lock
func (c *Omnilink) Lock(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) UnLock(in *types.WalletUnLock, result *interface{}) error {
...
func (c *Omnilink) GetPeerInfo(in *types.P2PGetPeerReq, result *interface{}) error {
...
func (c *Omnilink) GetHeaders(in *types.ReqBlocks, result *interface{}) error {
...
func (c *Omnilink) GetLastMemPool(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetPendingSize(in *types.ReqNil, result *interface{}) error {
	reply, err := c.cli.GetPendingSize()
	if err != nil {
		return err
	}
	var pendingSize rpctypes.ReplyPendingSize
	pendingSize.PendingSize = reply.GetPendingSize()
	*result = &pendingSize
	return nil
}

// GetProperFee get  contents in proper fee
func (c *Omnilink) GetProperFee(in *types.ReqProperFee, result *interface{}) error {
...
func (c *Omnilink) GetBlockOverview(in rpctypes.QueryParm, result *interface{}) error {
	var data types.ReqHash
	hash, err := common.FromHex(in.Hash)
	if err != nil {
		return err
...
func (c *Omnilink) GetAddrOverview(in *types.ReqAddr, result *interface{}) error {
...
func (c *Omnilink) GetBlockHash(in *types.ReqInt, result *interface{}) error {
...
// GenSeed seed
func (c *Omnilink) GenSeed(in *types.GenSeedLang, result *interface{}) error {
...
// SaveSeed save seed
func (c *Omnilink) SaveSeed(in *types.SaveSeedByPw, result *interface{}) error {
...
// GetSeed get seed
func (c *Omnilink) GetSeed(in *types.GetSeedByPw, result *interface{}) error {
...
func (c *Omnilink) GetWalletStatus(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetBalance(in *types.ReqBalance, result *interface{}) error {
	//增加addr地址的校验
...
func (c *Omnilink) GetAllExecBalance(in *types.ReqAllExecBalance, result *interface{}) error {
...
func (c *Omnilink) ExecWallet(in *rpctypes.ChainExecutor, result *interface{}) error {
...
// Query query
func (c *Omnilink) Query(in rpctypes.Query4Jrpc, result *interface{}) error {
	cfg := c.cli.GetConfig()
...
func (c *Omnilink) DumpPrivkey(in *types.ReqString, result *interface{}) error {
...
func (c *Omnilink) DumpPrivkeysFile(in *types.ReqPrivkeysFile, result *interface{}) error {
...
func (c *Omnilink) ImportPrivkeysFile(in *types.ReqPrivkeysFile, result *interface{}) error {
...
func (c *Omnilink) Version(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetTotalCoins(in *types.ReqGetTotalCoins, result *interface{}) error {
...
func (c *Omnilink) IsSync(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) IsNtpClockSync(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) QueryTotalFee(in *types.LocalDBGet, result *interface{}) error {
...
func (c *Omnilink) SignRawTx(in *types.ReqSignRawTx, result *interface{}) error {
...
func (c *Omnilink) GetNetInfo(in *types.P2PGetNetInfoReq, result *interface{}) error {
...
func (c *Omnilink) GetFatalFailure(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) DecodeRawTransaction(in *types.ReqDecodeRawTransaction, result *interface{}) error {
...
func (c *Omnilink) GetTimeStatus(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetServerTime(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) CloseQueue(in *types.ReqNil, result *interface{}) error {
	go func() {
...
func (c *Omnilink) GetLastBlockSequence(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetBlockSequences(in rpctypes.BlockParam, result *interface{}) error {
...
func (c *Omnilink) GetBlockByHashes(in rpctypes.ReqHashes, result *interface{}) error {
...
func (c *Omnilink) CreateTransaction(in *rpctypes.CreateTxIn, result *interface{}) error {
	if in == nil {
		return types.ErrInvalidParam
	}
	cfg := c.cli.GetConfig()
...
func (c *Omnilink) ConvertExectoAddr(in rpctypes.ExecNameParm, result *string) error {
	*result = address.ExecAddress(in.ExecName)
	return nil
}

// GetExecBalance get balance exec
func (c *Omnilink) GetExecBalance(in *types.ReqGetExecBalance, result *interface{}) error {
...
func (c *Omnilink) AddPushSubscribe(in *types.PushSubscribeReq, result *interface{}) error {
...
func (c *Omnilink) ListPushes(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetPushSeqLastNum(in *types.ReqString, result *interface{}) error {
...
func convertBlockDetails(details []*types.BlockDetail, retDetails *rpctypes.BlockDetails, isDetail bool, coinPercision int64) error {
	for _, item := range details {
		...
		if isDetail && len(txs) != len(item.Receipts) { //只有获取详情时才需要校验txs和Receipts的数量是否相等
...
func (c *Omnilink) GetCoinSymbol(in *types.ReqNil, result *interface{}) error {
	cfg := c.cli.GetConfig()
...
func (c *Omnilink) NetProtocols(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) GetSequenceByHash(in rpctypes.ReqHashes, result *interface{}) error {
...
func (c *Omnilink) GetBlockBySeq(in *types.Int64, result *interface{}) error {
...
func (c *Omnilink) GetParaTxByTitle(req *types.ReqParaTxByTitle, result *interface{}) error {
...
func (c *Omnilink) LoadParaTxByTitle(req *types.ReqHeightByTitle, result *interface{}) error {
...
func (c *Omnilink) GetParaTxByHeight(req *types.ReqParaTxByHeight, result *interface{}) error {
...
func (c *Omnilink) QueryChain(in rpctypes.ChainExecutor, result *interface{}) error {
...
func (c *Omnilink) GetChainID(in *types.ReqNil, result *interface{}) error {
	*result = &rpctypes.ChainIDInfo{ChainID: c.cli.GetConfig().GetChainID()}
	return nil
}

// GetCryptoList 获取加密列表
func (c *Omnilink) GetCryptoList(in *types.ReqNil, result *interface{}) error {
	*result = c.cli.GetCryptoList()
	return nil
}

// GetAddressDrivers 获取系统已注册地址插件
func (c *Omnilink) GetAddressDrivers(in *types.ReqNil, result *interface{}) error {
	*result = c.cli.GetAddressDrivers()
	return nil
}

// SendDelayTransaction send delay tx
func (c *Omnilink) SendDelayTransaction(in *types.ReqString, result *interface{}) error {
...
// GetWalletRecoverAddress get wallet recover omnilink addr
func (c *Omnilink) GetWalletRecoverAddress(req *types.ReqGetWalletRecoverAddr, result *interface{}) error {
...
func (c *Omnilink) SignWalletRecoverTx(req *types.ReqSignWalletRecoverTx, result *interface{}) error {
...
func (c *Omnilink) GetChainConfig(in *types.ReqNil, result *interface{}) error {
	cfg := c.cli.GetConfig()
	currentH := int64(0)
...
func (c *Omnilink) AddBlacklist(in *types.BlackPeer, result *interface{}) error {
...
func (c *Omnilink) DelBlacklist(in *types.BlackPeer, result *interface{}) error {
...
func (c *Omnilink) ShowBlacklist(in *types.ReqNil, result *interface{}) error {
...
func (c *Omnilink) DialPeer(in *types.SetPeer, result *interface{}) error {
...
func (c *Omnilink) ClosePeer(in *types.SetPeer, result *interface{}) error {
