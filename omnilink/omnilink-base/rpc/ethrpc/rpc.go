...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/common/utils"
	"code.corp.bcollie.net/omnilink/omnilink-base/queue"
	"code.corp.bcollie.net/omnilink/omnilink-base/rpc/ethrpc/admin"
	"code.corp.bcollie.net/omnilink/omnilink-base/rpc/ethrpc/eth"
	rpcNet "code.corp.bcollie.net/omnilink/omnilink-base/rpc/ethrpc/net"
	"code.corp.bcollie.net/omnilink/omnilink-base/rpc/ethrpc/personal"
	"code.corp.bcollie.net/omnilink/omnilink-base/rpc/ethrpc/web3"
...
type initAPI func(cfg *ctypes.OmnilinkConfig, c queue.Client, api client.QueueProtocolAPI) interface{}
...
func initRPCHandler(apis rpcAPIs, cfg *ctypes.OmnilinkConfig, c queue.Client, api client.QueueProtocolAPI) *rpcHandler {
