...
func TestErrLog(t *testing.T) {
	...
	//query transaction
	err = jrpcClient.Call("Omnilink.QueryTransaction", req, &testResult)
	assert.Nil(t, err)
...
func TestGetAllExecBalance(t *testing.T) {
	...
	err := jrpcClient.Call("Omnilink.GetAllExecBalance", &req, &res)
	assert.Nil(t, err)
...
func TestExprieCreateNoBalanceTransaction(t *testing.T) {
	...
	var groupres string
	err = jrpcClient.Call("Omnilink.CreateNoBalanceTransaction", req2, &groupres)
	assert.Nil(t, err)
...
func TestExprieSignRawTx(t *testing.T) {
	...
	var groupres string
	err = jrpcClient.Call("Omnilink.CreateRawTxGroup", req2, &groupres)
	assert.Nil(t, err)
	...
	err = jrpcClient.Call("Omnilink.SignRawTx", req3, &signgrouptx)
	assert.Nil(t, err)
