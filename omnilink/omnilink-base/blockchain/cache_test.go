...
func initTxHashCache(txHeightRange int64) (*txHashCache, *BlockChain, *types.OmnilinkConfig) {
	cfg := types.NewOmnilinkConfig(types.GetDefaultCfgstring())
...
func newTestTxs(cfg *types.OmnilinkConfig, priv crypto.PrivKey, currHeight, txHeightRange int64) []*types.Transaction {
...
func addTestBlock(chain *BlockChain, cfg *types.OmnilinkConfig, priv crypto.PrivKey, startHeight, txHeightRange int64, blockNum int) {
