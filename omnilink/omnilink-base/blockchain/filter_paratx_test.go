...
func addMainTx(cfg *types.OmnilinkConfig, priv crypto.PrivKey, api client.QueueProtocolAPI) (string, error) {
...
//构造单笔para交易
func addSingleParaTx(cfg *types.OmnilinkConfig, priv crypto.PrivKey, api client.QueueProtocolAPI, exec string) (string, error) {
...
//构造para交易组
func addGroupParaTx(cfg *types.OmnilinkConfig, priv crypto.PrivKey, api client.QueueProtocolAPI, title string, haveMainTx bool) (string, *types.ReplyStrings, error) {
...
//获取当前高度上的所有平行链title
func testGetParaTxByHeight(cfg *types.OmnilinkConfig, t *testing.T, blockchain *blockchain.BlockChain, height int64) {
...
//获取当前高度上的所有平行链title
func testParaTxByHeight(cfg *types.OmnilinkConfig, t *testing.T, blockchain *blockchain.BlockChain, height int64) {
