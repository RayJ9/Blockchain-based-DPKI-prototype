...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/cmd/tools/util"
)
...
func (ad *genDappStrategy) Run() error {
	fmt.Println("Begin generate omnilink dapp code.")
	defer fmt.Println("End generate omnilink dapp code.")
	if !ad.initMember() {
