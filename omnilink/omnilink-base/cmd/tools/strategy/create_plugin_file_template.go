...
`
	...
	CpftMakefile = `
OMNILINK=code.corp.bcollie.net/omnilink/omnilink-base
OMNILINK_PATH=vendor/${OMNILINK}
...
update:
	...
	rm -rf ${OMNILINK_PATH}
	git clone --depth 1 -b master https://${OMNILINK}.git ${OMNILINK_PATH}
	rm -rf vendor/${OMNILINK}/.git
	rm -rf vendor/${OMNILINK}/vendor/github.com/apache/thrift/tutorial/erl/
	cp -Rf vendor/${OMNILINK}/vendor/* vendor/
	rm -rf vendor/${OMNILINK}/vendor
	govendor init
	go build -i -o tool github.com/33cn/plugin/vendor/code.corp.bcollie.net/omnilink/omnilink-base/cmd/tools
