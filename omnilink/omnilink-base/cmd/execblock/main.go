...
var datadir = flag.String("datadir", "", "data dir of omnilink, include logs and datas")
var configPath = flag.String("f", "omnilink.toml", "configfile")
...
func initEnv() (queue.Queue, queue.Module, queue.Module) {
	cfg := types.NewOmnilinkConfig(types.ReadFile(*configPath))
