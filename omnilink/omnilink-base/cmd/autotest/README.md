...
#### **通过omnilink makefile**
omnilink开发人员修改框架或dapp代码，验证测试
```

//启动单节点solo版本omnilink，运行默认配置autotest，dapp用于指定需要跑的配置用例
...
### 扩展开发
分为以下几个步骤
> 注册dapp的AutoTest类型，以omnilink/system/dapp/coins为例
