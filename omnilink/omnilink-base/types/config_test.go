...
func TestChainConfig(t *testing.T) {
	cfg := NewOmnilinkConfig(GetDefaultCfgstring())
	cfg.S("a", true)
	_, err := cfg.G("b")
...
func TestSubConfig(t *testing.T) {
	cfg, err := initSubModuleString(readFile("testdata/omnilink.toml"))
...
func TestConfInit(t *testing.T) {
	cfg := NewOmnilinkConfig(ReadFile("testdata/omnilink.toml"))
	assert.True(t, cfg.IsEnable("TxHeight"))
}

func TestConfigNoInit(t *testing.T) {
	cfg := NewOmnilinkConfigNoInit(ReadFile("testdata/omnilink.toml"))
