...
// Hash 获取block的hash值
func (block *Block) Hash(cfg *OmnilinkConfig) []byte {
...
func (block *Block) GetHeader(cfg *OmnilinkConfig) *Header {
	head := &Header{}
...
func VerifySignature(cfg *OmnilinkConfig, block *Block, txs []*Transaction) bool {
	//检查区块的签名
...
func (block *Block) CheckSign(cfg *OmnilinkConfig) bool {
	return VerifySignature(cfg, block, block.Txs)
}

func (block *Block) verifySignature(cfg *OmnilinkConfig) bool {
...
func (blockDetail *BlockDetail) FilterParaTxsByTitle(cfg *OmnilinkConfig, title string) *ParaTxDetail {
