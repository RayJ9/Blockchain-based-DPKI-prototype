...
// 创建/调用合约的请求结构
type EVMContractAction4Omnilink struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EVMContractAction4Omnilink) Reset() {
	*x = EVMContractAction4Omnilink{}
	if protoimpl.UnsafeEnabled {
...
func (x *EVMContractAction4Omnilink) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EVMContractAction4Omnilink) ProtoMessage() {}

func (x *EVMContractAction4Omnilink) ProtoReflect() protoreflect.Message {
	mi := &file_evm_event_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EVMContractAction4Omnilink.ProtoReflect.Descriptor instead.
func (*EVMContractAction4Omnilink) Descriptor() ([]byte, []int) {
	return file_evm_event_proto_rawDescGZIP(), []int{5}
}

func (x *EVMContractAction4Omnilink) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *EVMContractAction4Omnilink) GetGasLimit() uint64 {
	if x != nil {
		return x.GasLimit
	}
	return 0
...
func (x *EVMContractAction4Omnilink) GetGasPrice() uint32 {
	if x != nil {
		return x.GasPrice
	}
	return 0
...
func (x *EVMContractAction4Omnilink) GetCode() []byte {
	if x != nil {
		return x.Code
	}
	return nil
...
func (x *EVMContractAction4Omnilink) GetPara() []byte {
	if x != nil {
		return x.Para
	}
	return nil
...
func (x *EVMContractAction4Omnilink) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
func (x *EVMContractAction4Omnilink) GetNote() string {
	if x != nil {
		return x.Note
	}
	return ""
...
func (x *EVMContractAction4Omnilink) GetContractAddr() string {
	if x != nil {
...
var file_evm_event_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x6f, 0x74, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74,
	0x41, 0x64, 0x64, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x61, 0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x42, 0x34, 0x5a, 0x32, 0x63, 0x6f, 0x64, 0x65,
	0x2e, 0x63, 0x6f, 0x72, 0x70, 0x2e, 0x62, 0x63, 0x6f, 0x6c, 0x6c, 0x69, 0x65, 0x2e, 0x6e, 0x65,
	0x74, 0x2f, 0x6f, 0x6d, 0x6e, 0x69, 0x6c, 0x69, 0x6e, 0x6b, 0x2f, 0x6f, 0x6d, 0x6e, 0x69, 0x6c,
	0x69, 0x6e, 0x6b, 0x2d, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06,
...
var file_evm_event_proto_goTypes = []interface{}{
	...
	(*EVMContractAction4Omnilink)(nil), // 5: types.EVMContractAction4Omnilink
...
func file_evm_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_evm_event_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EVMContractAction4Omnilink); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
