...
import (
	...
	sm2Util "code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/sm2"

	"code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/common/authority"
	"code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/common/authority/utils"
...
func initEnv() (*types.OmnilinkConfig, error) {
	cfg := types.NewOmnilinkConfig(types.ReadFile("./omnilink.auth.test.toml"))
