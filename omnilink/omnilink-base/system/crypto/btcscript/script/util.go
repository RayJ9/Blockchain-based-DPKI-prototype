...
// OmnilinkBtcParams 比特币相关区块链参数
var OmnilinkBtcParams = &chaincfg.Params{
	Name: "omnilink-btc-Script",
...
func GetBtcLockScript(scriptTy int32, pkScript []byte) (btcutil.Address, []byte, error) {
	...
	btcAddr, err := getBtcAddr(scriptTy, pkScript, OmnilinkBtcParams)
	if err != nil {
...
func GetBtcUnlockScript(signMsg, lockScript, prevScript []byte,
	...
	sigScript, err := txscript.SignTxOutput(OmnilinkBtcParams, btcTx, 0,
