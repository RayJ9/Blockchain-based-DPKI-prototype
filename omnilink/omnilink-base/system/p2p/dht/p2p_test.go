...
import (
	...
	l "code.corp.bcollie.net/omnilink/omnilink-base/common/log"
	p2p2 "code.corp.bcollie.net/omnilink/omnilink-base/p2p"
	"code.corp.bcollie.net/omnilink/omnilink-base/queue"
	cprotocol "code.corp.bcollie.net/omnilink/omnilink-base/system/p2p/dht/protocol"
	p2pty "code.corp.bcollie.net/omnilink/omnilink-base/system/p2p/dht/types"
...
func NewP2p(cfg *types.OmnilinkConfig, cli queue.Client) p2p2.IP2P {
