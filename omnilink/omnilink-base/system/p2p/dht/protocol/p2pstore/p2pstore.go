...
const (
	fetchActivePeer = "/omnilink/fetch-active-peer/1.0.0"
	fetchShardPeer  = "/omnilink/fetch-shard-peer/1.0.0"
	fetchChunk      = "/omnilink/fetch-chunk/1.0.0"
	//storeChunk      = "/omnilink/store-chunk/1.0.0"
	getHeader      = "/omnilink/headers/1.0.0"
	getChunkRecord = "/omnilink/chunk-record/1.0.0"
	fullNode       = "/omnilink/full-node/1.0.0"
	fetchPeerAddr  = "/omnilink/fetch-peer-addr/1.0.0"
	// Deprecated: old version, use getHeader instead
	getHeaderOld = "/omnilink/headerinfoReq/1.0.0"

	// 异步接口
	requestPeerAddr          = "/omnilink/request-peer-addr/1.0.0"
	responsePeerAddr         = "/omnilink/response-peer-addr/1.0.0"
	requestPeerInfoForChunk  = "/omnilink/request-peer-info-for-chunk/1.0.0"
	responsePeerInfoForChunk = "/omnilink/response-peer-info-for-chunk/1.0.0"
)
