...
const (
	...
	peerInfoOld = "/omnilink/peerinfoReq/1.0.0" //老版本
	peerInfo    = "/omnilink/peer-info/1.0.0"
	// Deprecated: old version, use peerVersion instead
	peerVersionOld = "/omnilink/peerVersion/1.0.0"
	peerVersion    = "/omnilink/peer-version/1.0.0"
)
