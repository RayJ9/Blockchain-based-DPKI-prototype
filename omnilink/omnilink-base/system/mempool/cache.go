...
func (cache *txCache) removeExpiredTx(cfg *types.OmnilinkConfig, height, blocktime int64) {
	var txs []string
...
//判断交易是否过期
func isExpired(cfg *types.OmnilinkConfig, item *Item, height, blockTime int64) bool {
