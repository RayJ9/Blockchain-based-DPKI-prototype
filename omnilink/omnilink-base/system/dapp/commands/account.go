...
import (
	...
	commandtypes "code.corp.bcollie.net/omnilink/omnilink-base/system/dapp/commands/types"
...
func dumpKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.DumpPrivkey", &params, &res)
	ctx.Run()
}
...
func listAccount(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetAccounts", nil, &res)
...
func balance(cmd *cobra.Command, args []string) {
	...
	if execer == "" && height == -1 {
		...
		ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetAllExecBalance", &req, &res)
	...
	if height >= 0 {
		...
		ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetHeaders", &params, &res)
		_, err := ctx.RunResult()
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetBalance", &params, &res)
...
func importKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.ImportPrivkey", &params, &res)
...
func createAccount(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.NewAccount", &params, &res)
...
func getRandAccount(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.NewRandAccount", &params, &res)
	ctx.Run()
}
...
func getAccount(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetAccount", &params, &res)
...
func setLabel(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.SetLabl", &params, &res)
	ctx.SetResultCbExt(parseSetLabelRes)
	ctx.RunExt(cfg)
}
...
func dumpKeys(cmd *cobra.Command, args []string) {
	...
	var res types.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.DumpPrivkeysFile", &params, &res)
	ctx.Run()
}
...
func importKeys(cmd *cobra.Command, args []string) {
	...
	var res types.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.ImportPrivkeysFile", &params, &res)
	ctx.Run()
}
