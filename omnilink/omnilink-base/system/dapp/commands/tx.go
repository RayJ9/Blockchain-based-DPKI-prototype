...
func queryTxByAddr(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetTxByAddr", &params, &res)
	ctx.Run()
}
...
func queryTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.QueryTransaction", params, &res)
...
func getTxsByHashes(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetTxByHashes", params, &res)
...
func getTxHexByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetHexTxByHash", params, nil)
...
func decodeTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.DecodeRawTransaction", &params, &res)
...
func viewAddress(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetAddrOverview", &params, &res)
...
func reWriteRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.ReWriteRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
