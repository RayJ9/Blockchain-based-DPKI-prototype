...
func peerInfo(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetPeerInfo", &req, &res)
	ctx.Run()
}
...
func isClockSync(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res bool
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.IsNtpClockSync", nil, &res)
	ctx.Run()
}
...
func isSync(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res bool
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.IsSync", nil, &res)
	ctx.Run()
}
...
func netInfo(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetNetInfo", &req, &res)
	ctx.Run()
}
...
func netProtocols(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.NetProtocols", &types.ReqNil{}, &res)
	ctx.Run()
}
...
func fatalFailure(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetFatalFailure", nil, &res)
	ctx.Run()
}
...
func timestatus(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.GetTimeStatus", nil, &res)
	ctx.Run()
}
...
func addblacklist(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.AddBlacklist", &peer, &res)
	ctx.Run()
}
...
func delblacklist(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.DelBlacklist", &peer, &res)
	ctx.Run()
...
func showblacklist(cmd *cobra.Command, args []string) {
	...
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.ShowBlacklist", nil, &res)
	ctx.Run()
...
func dialPeer(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.DialPeer", &setpeer, &res)
	ctx.Run()
}
...
func closePeer(cmd *cobra.Command, args []string) {
	...
	var res interface{}
	setpeer.Pid = pid
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.ClosePeer", &setpeer, &res)
	ctx.Run()
}
