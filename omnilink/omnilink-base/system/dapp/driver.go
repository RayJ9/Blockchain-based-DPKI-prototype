...
import (
	...
	nonetypes "code.corp.bcollie.net/omnilink/omnilink-base/system/dapp/none/types"

	"code.corp.bcollie.net/omnilink/omnilink-base/account"
	"code.corp.bcollie.net/omnilink/omnilink-base/client"
	"code.corp.bcollie.net/omnilink/omnilink-base/client/api"
...
type Driver interface {
	...
	SetExecutorAPI(queueapi client.QueueProtocolAPI, omnilinkapi types.OmnilinkClient)
...
func (d *DriverBase) SetExecutorAPI(queueapi client.QueueProtocolAPI, omnilinkapi types.OmnilinkClient) {
	d.execapi = api.New(queueapi, omnilinkapi)
}
...
func CheckAddress(cfg *types.OmnilinkConfig, addr string, height int64) error {
