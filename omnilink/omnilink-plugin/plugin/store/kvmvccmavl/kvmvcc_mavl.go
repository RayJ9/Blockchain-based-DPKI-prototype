...
import (
	...
	drivers "code.corp.bcollie.net/omnilink/omnilink-base/system/store"
	mavl "code.corp.bcollie.net/omnilink/omnilink-base/system/store/mavl/db"
...
func New(cfg *types.Store, sub []byte, omnilinkcfg *types.OmnilinkConfig) queue.Module {
	...
	// 读取fork高度
	if omnilinkcfg != nil {
		kvmvccMavlFork = omnilinkcfg.GetDappFork("store-kvmvccmavl", "ForkKvmvccmavl")
	}
	delMavlDataHeight = kvmvccMavlFork + 10000
	bs.SetChild(kvms)
	return kvms
