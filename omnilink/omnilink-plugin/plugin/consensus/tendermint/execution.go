...
import (
	...
	ttypes "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/consensus/tendermint/types"
	tmtypes "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/valnode/types"
)
