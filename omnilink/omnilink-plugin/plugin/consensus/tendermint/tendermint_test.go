...
import (
	...
	ty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/consensus/tendermint/types"
	pty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/norm/types"
	vty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/valnode/types"
