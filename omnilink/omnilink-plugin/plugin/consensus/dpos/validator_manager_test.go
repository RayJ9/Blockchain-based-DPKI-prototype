...
func TestMakeGenesisValidatorMgr(t *testing.T) {
	...
	require.Nil(t, err)
	assert.True(t, vMgr.ChainID == "omnilink-Z2cgFj")
	...
	vMgrCopy := vMgr.Copy()
	assert.True(t, vMgrCopy.ChainID == "omnilink-Z2cgFj")
