...
import (
	...
	dty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/dposvote/types"
...
func createConn(url string) (*grpc.ClientConn, types.OmnilinkClient, error) {
	var err error
	//url := "127.0.0.1:8802"
	...
	c1 := types.NewOmnilinkClient(conn)
...
func sendRegistCandidatorTx(cfg *types.OmnilinkConfig, ppubkey, addr, ip, privKey string) bool {
