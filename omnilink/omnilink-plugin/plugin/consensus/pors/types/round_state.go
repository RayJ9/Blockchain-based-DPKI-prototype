...
func InitMessageMap() {
	MsgMap = map[byte]reflect.Type{
		NewRoundStepID:      reflect.TypeOf(tmtypes.PorsNewRoundStepMsg{}),
		ProposalID:          reflect.TypeOf(tmtypes.PorsProposal{}),
		ProposalPOLID:       reflect.TypeOf(tmtypes.PorsProposalPOLMsg{}),
		VoteID:              reflect.TypeOf(tmtypes.PorsVote{}),
		HasVoteID:           reflect.TypeOf(tmtypes.PorsHasVoteMsg{}),
		VoteSetMaj23ID:      reflect.TypeOf(tmtypes.PorsVoteSetMaj23Msg{}),
		VoteSetBitsID:       reflect.TypeOf(tmtypes.PorsVoteSetBitsMsg{}),
		ProposalHeartbeatID: reflect.TypeOf(tmtypes.PorsHeartbeat{}),
		ProposalBlockID:     reflect.TypeOf(tmtypes.PorsBlock{}),
		ValidBlockID:        reflect.TypeOf(tmtypes.PorsValidBlockMsg{}),
		AggVoteID:           reflect.TypeOf(tmtypes.PorsAggVote{}),
	}
}
...
type RoundState struct {
	...
	Proposal       *tmtypes.PorsProposal
	ProposalBlock  *PorsBlock
	LockedRound    int
	LockedBlock    *PorsBlock
	ValidRound     int        // Last known round with POL for non-nil valid block.
	ValidBlock     *PorsBlock // Last known block of POL mentioned above.
	Votes          *HeightVoteSet
	CommitRound    int
...
// RoundStateMessage ...
func (rs *RoundState) RoundStateMessage() *tmtypes.PorsNewRoundStepMsg {
	return &tmtypes.PorsNewRoundStepMsg{
		Height:                rs.Height,
...
type PeerRoundState struct {
	...
	ProposalPOLRound   int       // PorsProposal's POL round. -1 if none.
