...
func requestMainBlocks(cfg *types.OmnilinkConfig, inv *inventory) (*types.ParaTxDetails, error) {
...
func requestMainBlockWithTime(cfg *types.OmnilinkConfig, inv *inventory) *types.ParaTxDetails {
