...
import (
	...
	apimocks "code.corp.bcollie.net/omnilink/omnilink-base/client/mocks"
	...
	paraexec "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/paracross/executor"
...
func TestFilterTxsForPara(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.ReadFile("../../../plugin/dapp/paracross/cmd/build/omnilink.para.test.toml"))
...
func createCrossParaTx(cfg *types.OmnilinkConfig, to string, amount int64) (*types.Transaction, error) {
...
func createCrossParaTempTx(cfg *types.OmnilinkConfig, to string, amount int64) (*types.Transaction, error) {
	param := types.CreateTx{
		To:          to,
		Amount:      amount,
		Fee:         0,
...
func createTxsGroup(cfg *types.OmnilinkConfig, txs []*types.Transaction) ([]*types.Transaction, error) {
...
func createTestTxs(cfg *types.OmnilinkConfig, t *testing.T) (*types.BlockDetail, []*types.Transaction, []*types.Transaction) {
	//all para tx group
...
func getMockLastBlock(para *client, returnBlock *types.Block) {
	...
	qClient.On("GetConfig").Return(&types.OmnilinkConfig{})
