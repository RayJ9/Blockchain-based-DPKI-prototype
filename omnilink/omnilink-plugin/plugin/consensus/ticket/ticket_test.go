...
func createBindMiner(cfg *types.OmnilinkConfig, t *testing.T, m, r string, priv crypto.PrivKey) *types.Transaction {
...
func Test_getNextRequiredDifficulty(t *testing.T) {
	cfg := types.NewOmnilinkConfig(types.ReadFile("testdata/omnilink.cfg.toml"))
