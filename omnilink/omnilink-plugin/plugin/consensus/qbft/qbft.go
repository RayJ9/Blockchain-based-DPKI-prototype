...
import (
	...
	ttypes "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/consensus/qbft/types"
	tmtypes "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/qbftNode/types"
...
func (client *Client) BuildBlock(height int64) *types.Block {
	...
	newblock.BlockTime = types.Now().UnixMilli()
