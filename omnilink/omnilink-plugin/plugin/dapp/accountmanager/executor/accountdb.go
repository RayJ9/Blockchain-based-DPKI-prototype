...
import (
	...
	tab "code.corp.bcollie.net/omnilink/omnilink-base/common/db/table"
	"code.corp.bcollie.net/omnilink/omnilink-base/system/dapp"
	"code.corp.bcollie.net/omnilink/omnilink-base/types"
	et "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/accountmanager/types"
)
...
func getManagerAddr(cfg *types.OmnilinkConfig, db dbm.KV, key, defaultValue string) string {
	var item types.ConfigItem
	value, err := getManageKey(cfg, key, db)
	if err != nil {
		return defaultValue
...
func queryBalanceByID(statedb, localdb dbm.KV, cfg *types.OmnilinkConfig, execName string, in *et.QueryBalanceByID) (*et.Balance, error) {
