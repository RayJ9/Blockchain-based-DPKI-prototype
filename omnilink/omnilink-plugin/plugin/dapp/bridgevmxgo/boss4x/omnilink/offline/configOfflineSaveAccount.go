...
/*
./boss4x omnilink offline set_offline_addr -a 16skyHQA4YPPnhrDSSpZnexDzasS8BNx1R -c 1QD5pHMKZ9QWiNb9AsH3G1aG3Hashye83o -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae --chainID 33
./boss4x omnilink offline send -f omnilink_set_offline_addr.txt
*/
...
func ConfigMultisignOfflineSaveAccount(cmd *cobra.Command, _ []string) {
	...
	callContractAndSignWrite(cmd, packData, contract, "omnilink_set_offline_addr")
}
