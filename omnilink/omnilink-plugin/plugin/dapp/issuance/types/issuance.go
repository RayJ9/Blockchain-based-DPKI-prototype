...
// NewType method
func NewType(cfg *types.OmnilinkConfig) *IssuanceType {
	c := &IssuanceType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawIssuanceCreateTx(cfg *types.OmnilinkConfig, parm *IssuanceCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceDebtTx(cfg *types.OmnilinkConfig, parm *IssuanceDebtTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceRepayTx(cfg *types.OmnilinkConfig, parm *IssuanceRepayTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceFeedTx(cfg *types.OmnilinkConfig, parm *IssuanceFeedTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceCloseTx(cfg *types.OmnilinkConfig, parm *IssuanceCloseTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceManageTx(cfg *types.OmnilinkConfig, parm *IssuanceManageTx) (*types.Transaction, error) {
	if parm == nil {
