...
import (
	...
	tt "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/token/types"
...
func NewGRPCCli(grpcAddr string) *GRPCCli {
	...
	cfg := types.NewOmnilinkConfig(et.GetDefaultCfgstring())
