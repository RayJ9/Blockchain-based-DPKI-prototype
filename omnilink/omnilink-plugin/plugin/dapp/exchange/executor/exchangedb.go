...
import (
	...
	et "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/exchange/types"
)
...
func ParseConfig(cfg *types.OmnilinkConfig, height int64) (*et.Econfig, error) {
...
func ParseStrings(cfg *types.OmnilinkConfig, tradeKey string, height int64) (ret []string, err error) {
...
func ParseCoins(cfg *types.OmnilinkConfig, tradeKey string, height int64) (coins []et.CoinCfg, err error) {
...
func ParseSymbols(cfg *types.OmnilinkConfig, tradeKey string, height int64) (symbols map[string]*et.Trade, err error) {
