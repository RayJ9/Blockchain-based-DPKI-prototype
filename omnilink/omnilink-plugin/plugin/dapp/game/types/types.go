...
//也就是说，我们可以构造其他平行链的交易
func getRealExecName(cfg *types.OmnilinkConfig, paraName string) string {
	return cfg.ExecName(paraName + GameX)
}

// NewType  new type
func NewType(cfg *types.OmnilinkConfig) *GameType {
	c := &GameType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawGamePreCreateTx(cfg *types.OmnilinkConfig, parm *GamePreCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawGamePreMatchTx(cfg *types.OmnilinkConfig, parm *GamePreMatchTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawGamePreCancelTx(cfg *types.OmnilinkConfig, parm *GamePreCancelTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameCancel{
...
func CreateRawGamePreCloseTx(cfg *types.OmnilinkConfig, parm *GamePreCloseTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameClose{
