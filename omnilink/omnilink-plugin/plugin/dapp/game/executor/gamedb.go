...
func List(cfg *types.OmnilinkConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
	return QueryGameListByPage(cfg, db, stateDB, param)
}

// QueryGameListByPage 分页查询
func QueryGameListByPage(cfg *types.OmnilinkConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
...
func queryGameListByStatusAndAddr(cfg *types.OmnilinkConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
	direction := ListDESC
...
func getConfValue(cfg *types.OmnilinkConfig, db dbm.KV, key string, defaultValue int64) int64 {
...
func getManageKey(cfg *types.OmnilinkConfig, key string, db dbm.KV) ([]byte, error) {
