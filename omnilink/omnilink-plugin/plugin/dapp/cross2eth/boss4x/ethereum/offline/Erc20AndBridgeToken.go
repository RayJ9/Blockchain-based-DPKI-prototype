...
import (
	...
	tetherUSDT "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cross2eth/contracts/usdt/generated"
...
func CreateBridgeTokenTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "create new token as omnilink asset on Ethereum, and it's should be done by operator",
