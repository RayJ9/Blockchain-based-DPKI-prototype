...
import (
	...
	localUtils "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cross2eth/ebrelayer/utils"
...
/*
./boss4x omnilink offline create_erc20 -s YCC -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae -o 1N6HstkyLFS8QCeVfdvYxx1xoryXoJtvvZ --chainID 33
./boss4x omnilink offline send -f deployErc20YCCOmnilink.txt

./boss4x omnilink offline approve_erc20 -a 330000000000 -s 1JmWVu1GEdQYSN1opxS9C39aS4NvG57yTr -c 1998HqVnt4JUirhC9KL5V71xYU8cFRn82c -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae  --chainID 33
./boss4x omnilink offline send -f approve_erc20.txt

./boss4x omnilink offline create_add_lock_list -c 1JmWVu1GEdQYSN1opxS9C39aS4NvG57yTr -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae -t 1998HqVnt4JUirhC9KL5V71xYU8cFRn82c --chainID 33 -s YCC
./boss4x omnilink offline send -f create_add_lock_list.txt

./boss4x omnilink offline create_bridge_token -c 1JmWVu1GEdQYSN1opxS9C39aS4NvG57yTr -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae -s YCC --chainID 33
./boss4x omnilink offline send -f create_bridge_token.txt
${OmnilinkCli} evm abi call -a "${omnilinkBridgeBank}" -c "${omnilinkDeployAddr}" -b "getToken2address(YCC)"
./omnilink-cli evm abi call -a 1JmWVu1GEdQYSN1opxS9C39aS4NvG57yTr -c 1N6HstkyLFS8QCeVfdvYxx1xoryXoJtvvZ -b 'getToken2address(YCC)'
*/
...
func CreateERC20(cmd *cobra.Command, _ []string) {
	...
	Erc20Tx := &utils.OmnilinkOfflineTx{
	...
	fileName := fmt.Sprintf("deployErc20%sOmnilink.txt", symbol)
...
func CreateNewBridgeTokenCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "create new token as ethereum asset on omnilink, and it's should be done by operator",
...
func SetWithdrawProxyCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "set withdraw proxy on omnilink, and it's should be done by operator",
...
func withdrawFromEvmCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "withdraw",
		Short: "withdraw asset from omnilink evm, including approve and burn txs",
		Run:   withdrawFromEvm,
	}
...
func callContractAndSign(cmd *cobra.Command, para []byte, contractAddr, name string) *utils.OmnilinkOfflineTx {
