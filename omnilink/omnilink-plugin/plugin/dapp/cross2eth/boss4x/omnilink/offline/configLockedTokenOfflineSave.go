...
import (
	...
	utilsRelayer "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cross2eth/ebrelayer/utils"
	evmAbi "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/abi"
	"github.com/spf13/cobra"
)

/*
./boss4x omnilink offline set_offline_token -c 1MaP3rrwiLV1wrxPhDwAfHggtei1ByaKrP -s BTY -m 100000000000 -p 50 -k 0x027ca96466c71c7e7c5d73b7e1f43cb889b3bd65ebd2413eefd31c6709c262ae --chainID 33
./boss4x omnilink offline send -f omnilink_set_offline_token.txt
*/
...
func ConfigMultisignLockedTokenOfflineSave(cmd *cobra.Command, _ []string) {
	...
	callContractAndSignWrite(cmd, packData, contract, "omnilink_set_offline_token")
}
