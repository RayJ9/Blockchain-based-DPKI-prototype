...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cross2eth/ebcli/buildflags"
...
var (
	rootCmd = &cobra.Command{
		Use:   "omnilinkxEth-relayer" + "-cli",
		Short: "omnilinkxEth-relayer" + "client tools",
	}
