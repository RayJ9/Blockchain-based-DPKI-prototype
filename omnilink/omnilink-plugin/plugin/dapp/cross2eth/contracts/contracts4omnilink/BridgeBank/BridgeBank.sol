 ...
 *      represent Ethereum based assets, while OmnilinkBank manages
 *      the locking and unlocking of Omnilink and ERC20 token assets
 *      based on Omnilink.
 **/

contract BridgeBank is EthereumBank, OmnilinkBank {
    ...
    */
     ...
     * @param _omnilinkRecipient: The intended recipient's Omnilink address.
     ...
     * @param _ethereumTokenAddress: The token address mint on omnilink and it's origin from Ethereum
     ...
     *
     * @param _ethereumReceiver: The _ethereum receiver address in bytes.
     * @param _bridgeTokenAddress: The bridge Token Address issued in omnilink and it's origin from Ethereum/BSC
   ...
   */
    ...
    /*
    * @dev: Locks received Omnilink funds.
    *
    * @param _recipient: bytes representation of destination address.
    * @param _token: token address in origin chain (0x0 if omnilink)
        ...
        payable
    {
        ...
        if (msg.value > 0) {
          ...
          require(
              ...
              'The token is not allowed to be locked from Omnilink.'
          );
        }
   ...
   /*
    * @dev: Unlocks Omnilink and ERC20 tokens held on the contract.
    *
    * @param _recipient: recipient's Omnilink address
    * @param _token: token contract address
    * @param _symbol: token symbol
...
\   */
    ...
    * @return: Original sender's Omnilink address.
