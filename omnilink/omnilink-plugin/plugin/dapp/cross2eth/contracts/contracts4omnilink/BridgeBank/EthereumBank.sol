...
contract EthereumBank {
    ...
    struct EthereumDeposit {
        ...
        address payable omnilinkRecipient;
    ...
    */
    function newEthereumDeposit(
        ...
        address payable _omnilinkRecipient,
        address _token,
        uint256 _amount
    )
        internal
    ...
    * @dev: Creates a new EthereumBurn with a unique ID
        *
        * @param _ethereumSender: The sender's Ethereum address in bytes.
        * @param _omnilinkOwner: The owner's Omnilink address.
        ...
        */
        function newEthereumBurn(
            bytes memory _ethereumSender,
            address payable _omnilinkOwner,
            address _token,
            uint256 _amount,
            uint256 nonce
        )
     ...
     * @param _ethereumTokenAddress: The token address of ethereum asset issued on omnilink
     ...
     * @param _ethereumReceiver: The receiver's Ethereum address in bytes.
     * @param _bridgeTokenAddress: The token address of ethereum asset issued on omnilink
  ...
  /*
    ...
    * @return: Amount of omnilink/erc20 in the item.
