...
type SyncTxConfig struct {
	OmnilinkHost          string   `protobuf:"bytes,1,opt,name=omnilinkhost,proto3" json:"omnilinkhost,omitempty"`
	...
	OmnilinkRpcUrls       []string `protobuf:"bytes,14,rep,name=omnilinkRpcUrls,proto3" json:"omnilinkRpcUrls,omitempty"`
...
func (m *SyncTxConfig) GetOmnilinkHost() string {
	if m != nil {
		return m.OmnilinkHost
	}
	return ""
}
...
func (m *SyncTxConfig) GetOmnilinkRpcUrls() []string {
	if m != nil {
		return m.OmnilinkRpcUrls
	}
	return nil
}
...
type OmnilinkRelayerCfg struct {
	SyncTxConfig            *SyncTxConfig `protobuf:"bytes,1,opt,name=syncTxConfig,proto3" json:"syncTxConfig,omitempty"`
	BridgeRegistryOnOmnilink string        `protobuf:"bytes,2,opt,name=bridgeRegistryOnOmnilink,proto3" json:"bridgeRegistryOnOmnilink,omitempty"`
	ChainName               string        `protobuf:"bytes,3,opt,name=chainName,proto3" json:"chainName,omitempty"`
	ChainID4Omnilink         int32         `protobuf:"varint,4,opt,name=chainID4Omnilink,proto3" json:"chainID4Omnilink,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}      `json:"-"`
	XXX_unrecognized        []byte        `json:"-"`
	XXX_sizecache           int32         `json:"-"`
}

func (m *OmnilinkRelayerCfg) Reset()         { *m = OmnilinkRelayerCfg{} }
func (m *OmnilinkRelayerCfg) String() string { return proto.CompactTextString(m) }
func (*OmnilinkRelayerCfg) ProtoMessage()    {}
func (*OmnilinkRelayerCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_3eaf2c85e69e9ea4, []int{3}
}

func (m *OmnilinkRelayerCfg) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OmnilinkRelayerCfg.Unmarshal(m, b)
}
func (m *OmnilinkRelayerCfg) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OmnilinkRelayerCfg.Marshal(b, m, deterministic)
}
func (m *OmnilinkRelayerCfg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OmnilinkRelayerCfg.Merge(m, src)
}
func (m *OmnilinkRelayerCfg) XXX_Size() int {
	return xxx_messageInfo_OmnilinkRelayerCfg.Size(m)
}
func (m *OmnilinkRelayerCfg) XXX_DiscardUnknown() {
	xxx_messageInfo_OmnilinkRelayerCfg.DiscardUnknown(m)
}

var xxx_messageInfo_OmnilinkRelayerCfg proto.InternalMessageInfo

func (m *OmnilinkRelayerCfg) GetSyncTxConfig() *SyncTxConfig {
	if m != nil {
...
func (m *OmnilinkRelayerCfg) GetBridgeRegistryOnOmnilink() string {
	if m != nil {
		return m.BridgeRegistryOnOmnilink
	}
	return ""
}

func (m *OmnilinkRelayerCfg) GetChainName() string {
	if m != nil {
		return m.ChainName
	}
	return ""
...
func (m *OmnilinkRelayerCfg) GetChainID4Omnilink() int32 {
	if m != nil {
		return m.ChainID4Omnilink
	}
	return 0
}
...
type RelayerConfig struct {
	...
	OmnilinkRelayerCfg    *OmnilinkRelayerCfg `protobuf:"bytes,4,opt,name=omnilinkRelayerCfg,proto3" json:"omnilinkRelayerCfg,omitempty"`
...
func (m *RelayerConfig) GetOmnilinkRelayerCfg() *OmnilinkRelayerCfg {
	if m != nil {
		return m.OmnilinkRelayerCfg
	}
	return nil
}
...
func (m *SyncTxReceiptConfig) GetOmnilinkHost() string {
	if m != nil {
		return m.OmnilinkHost
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*OmnilinkRelayerCfg)(nil), "types.OmnilinkRelayerCfg")
