...
const (
	OmnilinkBlockChainName    = "Omnilink-mainchain"
	EthereumBlockChainName    = "Ethereum-mainchain"
	BinanceChainName          = "Binance"
	EthereumChainName         = "Ethereum"
	BTYAddrOmnilink           = "1111111111111111111114oLvT2"
	NilAddrOmnilink           = "1111111111111111111114oLvT2"
	...
	Source_Chain_Omnilink     = int32(1)
	Invalid_Tx_Index          = int64(0)
	Invalid_OmnilinkTx_Status = int32(-1)
)
