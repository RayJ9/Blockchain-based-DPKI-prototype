...
func Test_LoadABI(t *testing.T) {
	abi1 := LoadABI(OmnilinkBankABI)
	abi2 := LoadABI(OmnilinkBridgeABI)
...
func TestContractRegistry_String(t *testing.T) {
	...
	assert.Equal(t, OmnilinkBridge.String(), "omnilinkbridge")
}
...
func Test_RelayOracleClaimToEthereum(t *testing.T) {
	...
	privateKeySlice, err := omnilinkCommon.FromHex("0x3fa21584ae2e4fd74db9b58e2386f5481607dfa4d7ba0617aaa7858e5025dc1e")
	require.Nil(t, err)
	...
	prophecyClaim := ProphecyClaim{
		...
		OmnilinkSender:       []byte("12qyocayNF7Lv6C9qW4avxs2E7U41fKSfv"),
		...
		OmnilinkTxHash:       common.Hex2Bytes("fd5747c43d1460bb6f8a7a26c66b4ccab5500d05668278efe5c0fd5951dfd909"),
	}
...
func DeployAndInit(client ethinterface.EthClientSpec, para *DeployPara) (*X2EthContracts, *X2EthDeployInfo, error) {
	...
	_, err = x2EthContracts.OmnilinkBridge.SetBridgeBank(auth, deployInfo.BridgeBank.Address)
	if nil != err {
	...
	_, err = x2EthContracts.OmnilinkBridge.SetOracle(auth, deployInfo.Oracle.Address)
	if nil != err {
