...
import (
	...
	pty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/hashlock/types"
...
func hashlockLockCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.CreateTransaction", paramWithExecAction, nil)
