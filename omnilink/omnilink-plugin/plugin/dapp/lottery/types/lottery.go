...
// NewType method
func NewType(cfg *types.OmnilinkConfig) *LotteryType {
	c := &LotteryType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawLotteryCreateTx(cfg *types.OmnilinkConfig, parm *LotteryCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryBuyTx(cfg *types.OmnilinkConfig, parm *LotteryBuyTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryDrawTx(cfg *types.OmnilinkConfig, parm *LotteryDrawTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryCloseTx(cfg *types.OmnilinkConfig, parm *LotteryCloseTx) (*types.Transaction, error) {
	if parm == nil {
