...
import (
	...
	rt "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/lottery/types"
)
...
var (
	...
	mydb         db.KV
	lotteryID    string
	chainTestCfg *types.OmnilinkConfig
)
...
func constructLotteryInstance() drivers.Driver {
	chainTestCfg = types.NewOmnilinkConfig(types.GetDefaultCfgstring())
