...
import (
	...
	_ "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/consensus/init"
	_ "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/ticket"
)

var mock33 *testnode.OmnilinkMock

func TestMain(m *testing.M) {
	mock33 = testnode.New("testdata/omnilink.cfg.toml", nil)
	mock33.Listen()
	code := m.Run()
	mock33.Close()
	os.Exit(code)
...
func createBindMiner(t *testing.T, cfg *types.OmnilinkConfig, m, r string, priv crypto.PrivKey) *types.Transaction {
...
func ticketList(t *testing.T, mock33 *testnode.OmnilinkMock, req proto.Message) *ty.ReplyTicketList {
