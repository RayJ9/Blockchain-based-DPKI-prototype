...
// NewType method
func NewType(cfg *types.OmnilinkConfig) *CollateralizeType {
	c := &CollateralizeType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawCollateralizeCreateTx(cfg *types.OmnilinkConfig, parm *CollateralizeCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeBorrowTx(cfg *types.OmnilinkConfig, parm *CollateralizeBorrowTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeRepayTx(cfg *types.OmnilinkConfig, parm *CollateralizeRepayTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeAppendTx(cfg *types.OmnilinkConfig, parm *CollateralizeAppendTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeFeedTx(cfg *types.OmnilinkConfig, parm *CollateralizeFeedTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeRetrieveTx(cfg *types.OmnilinkConfig, parm *CollateralizeRetrieveTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeManageTx(cfg *types.OmnilinkConfig, parm *CollateralizeManageTx) (*types.Transaction, error) {
	if parm == nil {
