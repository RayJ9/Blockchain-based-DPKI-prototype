...
import (
	...
	pty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/collateralize/types"
	issuanceE "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/issuance/types"
