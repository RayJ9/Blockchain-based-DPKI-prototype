...
func newTestOmnilink() (*mocks.QueueProtocolAPI, *Jrpc) {
...
func TestOmnilink_CreateRawTradeSellTx(t *testing.T) {
	_, client := newTestOmnilink()
...
func TestOmnilink_CreateRawTradeBuyTx(t *testing.T) {
	_, client := newTestOmnilink()
	var testResult interface{}
...
func TestOmnilink_CreateRawTradeRevokeTx(t *testing.T) {
	_, client := newTestOmnilink()
	var testResult interface{}
...
func TestOmnilink_CreateRawTradeBuyLimitTx(t *testing.T) {
	_, client := newTestOmnilink()
	var testResult interface{}
...
func TestOmnilink_CreateRawTradeSellMarketTx(t *testing.T) {
	_, client := newTestOmnilink()
	var testResult interface{}
...
func TestOmnilink_CreateRawTradeRevokeBuyTx(t *testing.T) {
	_, client := newTestOmnilink()
	var testResult interface{}
...
func TestOmnilink_GetLastMemPoolOk(t *testing.T) {
	api, testOmnilink := newTestOmnilink()
	cfg := api.GetConfig()
