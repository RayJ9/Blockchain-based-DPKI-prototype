...
//NewType ...
func NewType(cfg *types.OmnilinkConfig) *TradeType {
	c := &TradeType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawTradeSellTx(cfg *types.OmnilinkConfig, parm *TradeSellTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &TradeForSell{
...
func CreateRawTradeBuyTx(cfg *types.OmnilinkConfig, parm *TradeBuyTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeRevokeTx(cfg *types.OmnilinkConfig, parm *TradeRevokeTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeBuyLimitTx(cfg *types.OmnilinkConfig, parm *TradeBuyLimitTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &TradeForBuyLimit{
...
func CreateRawTradeSellMarketTx(cfg *types.OmnilinkConfig, parm *TradeSellMarketTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeRevokeBuyTx(cfg *types.OmnilinkConfig, parm *TradeRevokeBuyTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
