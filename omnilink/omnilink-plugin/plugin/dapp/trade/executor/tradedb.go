...
func (selldb *sellDB) getSellLogs(tradeType int32, txhash string, cfg *types.OmnilinkConfig) *types.ReceiptLog {
...
func (selldb *sellDB) getBuyLogs(buyerAddr string, boardlotcnt int64, txhash string, cfg *types.OmnilinkConfig) *types.ReceiptLog {
	log := &types.ReceiptLog{}
...
func (buydb *buyDB) getBuyLogs(tradeType int32, txhash string, cfg *types.OmnilinkConfig) *types.ReceiptLog {
	log := &types.ReceiptLog{}
	log.Ty = tradeType
	base := &pty.ReceiptBuyBase{
...
func (buydb *buyDB) getSellLogs(sellerAddr string, sellID string, boardlotCnt int64, txhash string, cfg *types.OmnilinkConfig) *types.ReceiptLog {
	log := &types.ReceiptLog{}
