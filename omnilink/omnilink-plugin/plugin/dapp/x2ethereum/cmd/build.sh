...
#SRC_EBCLI=code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/x2ethereum/ebcli
#SRC_EBRELAYER=code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/x2ethereum/ebrelayer
#OUT_DIR="${1}/$strapp"
#FLAG=$2
#
