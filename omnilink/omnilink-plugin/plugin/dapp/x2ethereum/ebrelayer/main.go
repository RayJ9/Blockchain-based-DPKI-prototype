...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/x2ethereum/ebrelayer/relayer"
	ethRelayer "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/x2ethereum/ebrelayer/relayer/ethereum"
	omnilinkRelayer "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/x2ethereum/ebrelayer/relayer/omnilink"
...
func main() {
	...
	omnilinkRelayerService := omnilinkRelayer.StartOmnilinkRelayer(ctx, cfg.SyncTxConfig, cfg.BridgeRegistry, cfg.EthProvider, db)
	ethRelayerService := ethRelayer.StartEthereumRelayer(cfg.SyncTxConfig.OmnilinkHost, db, cfg.EthProvider, cfg.BridgeRegistry, cfg.Deploy, cfg.EthMaturityDegree, cfg.EthBlockFetchPeriod)

	relayerManager := relayer.NewRelayerManager(omnilinkRelayerService, ethRelayerService, db)
