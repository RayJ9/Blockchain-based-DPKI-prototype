...
contract Oracle {
    ...
    */
    ...
    {
        require(
            omnilinkBridge.isProphecyClaimActive(
                _claimID
            ) == true,
    ...
    */
    ...
    {
        require(
           omnilinkBridge.isValidClaimType(
               uint8(_claimType)
           ) == true,
    ...
    */
    ...
    {
        operator = _operator;
        omnilinkBridge = OmnilinkBridge(_omnilinkBridge);
        valset = Valset(_valset);
    }

    /*
    * @dev: newOracleClaim
    *       Allows validators to make new OracleClaims on omnilink lock/burn prophecy,
    *       if the required vote power reached,just make it processed
    * @param _claimType: burn or lock,
    * @param _omnilinkSender: omnilink sender,
    ...
    */
        ...
        isValidClaimType(_claimType)
    {
        ...
        if (oracleClaimValidators[_claimID].length == 0) {
             omnilinkBridge.setNewProphecyClaim(
                            _claimID,
                            uint8(_claimType),
                            _omnilinkSender,
                            _ethereumReceiver,
        ...
        if (true == valid)  {
            ...
            if (omnilinkBridge.isProphecyClaimActive(_claimID) == true) {
