...
type ValidatorAddr4EthRelayer struct {
	OmnilinkValidator string `protobuf:"bytes,1,opt,name=omnilinkValidator" json:"omnilinkValidator,omitempty"`
}
...
type EthBridgeClaim struct {
	...
	OmnilinkReceiver string `protobuf:"bytes,7,opt,name=omnilinkReceiver" json:"omnilinkReceiver,omitempty"`
...
type NewProphecyClaim struct {
	...
	OmnilinkSender string `protobuf:"bytes,2,opt,name=omnilinkSender" json:"omnilinkSender,omitempty"`
...
type LockEthErc20 struct {
	...
	OmnilinkReceiver string `protobuf:"bytes,4,opt,name=omnilinkReceiver" json:"omnilinkReceiver,omitempty"`
}
