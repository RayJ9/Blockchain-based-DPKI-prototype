...
//CalEth2OmnilinkPrefix ...
func CalEth2OmnilinkPrefix() []byte {
	return []byte(KeyPrefixStateDB + string(Eth2OmnilinkKey))
}
...
//CalOmnilinkToEthPrefix ...
func CalOmnilinkToEthPrefix() []byte {
	return []byte(KeyPrefixStateDB + string(OmnilinkToEthKey))
}

//CalWithdrawOmnilinkPrefix ...
func CalWithdrawOmnilinkPrefix() []byte {
	return []byte(KeyPrefixStateDB + string(WithdrawOmnilinkKey))
}
