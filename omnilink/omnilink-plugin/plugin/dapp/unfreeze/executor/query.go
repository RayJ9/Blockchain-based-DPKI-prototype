...
func QueryWithdraw(cfg *types.OmnilinkConfig, stateDB dbm.KV, id string) (types.Message, error) {
...
func getWithdrawAvailable(cfg *types.OmnilinkConfig, unfreeze *pty.Unfreeze, calcTime int64) (int64, error) {
