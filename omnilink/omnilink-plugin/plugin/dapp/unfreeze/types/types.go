...
// NewType 生成新的基础类型
func NewType(cfg *types.OmnilinkConfig) *UnfreezeType {
	c := &UnfreezeType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateUnfreezeCreateTx(cfg *types.OmnilinkConfig, title string, parm *UnfreezeCreate) (*types.Transaction, error) {
...
func CreateUnfreezeWithdrawTx(cfg *types.OmnilinkConfig, title string, parm *UnfreezeWithdraw) (*types.Transaction, error) {
	if parm == nil {
...
func CreateUnfreezeTerminateTx(cfg *types.OmnilinkConfig, title string, parm *UnfreezeTerminate) (*types.Transaction, error) {
	if parm == nil {
