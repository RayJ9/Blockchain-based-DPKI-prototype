...
*/
func transferInput(cfg *types.OmnilinkConfig, db dbm.KV, execer, symbol string, proof *mixTy.ZkProofInfo) (*mixTy.TransferInputCircuit, error) {
...
*/
func transferOutputVerify(cfg *types.OmnilinkConfig, db dbm.KV, proof *mixTy.ZkProofInfo) (*mixTy.TransferOutputCircuit, error) {
...
func MixTransferInfoVerify(cfg *types.OmnilinkConfig, db dbm.KV, transfer *mixTy.MixTransferAction) ([]*mixTy.TransferInputCircuit, []*mixTy.TransferOutputCircuit, error) {
