...
import (
	...
	omnilinkComm "code.corp.bcollie.net/omnilink/omnilink-base/common"
	...
	evm "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/types"
)
...
func (c *Jrpc) CalcNewContractAddr(parm *evm.EvmCalcNewContractAddrReq, result *interface{}) error {
	...
	hashByte, err := omnilinkComm.FromHex(parm.Txhash)
	if err != nil {
