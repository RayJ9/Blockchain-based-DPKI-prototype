...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/system/address/btc"
...
// Address 封装evm内部地址对象
// raw为地址原始数据
// formatAddr为omnilink框架中格式化地址, 相关转换格式由默认地址插件指定
// omnilink => evm, 即将formatAddr转换为raw数据, [20]byte
// evm => omnilink, 即将原始数据raw格式化为formatAddr
type Address struct {
