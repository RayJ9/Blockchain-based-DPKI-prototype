...
import (
	...
	cloudflare "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto/bn256/cloudflare"
	google "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto/bn256/google"
)
