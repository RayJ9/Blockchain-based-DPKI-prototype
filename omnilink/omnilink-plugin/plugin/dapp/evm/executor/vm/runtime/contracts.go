...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto/blake2b"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto/bls12381"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common/crypto/bn256"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/params"
...
// PrecompiledContractsByzantium omnilink平台支持君士坦丁堡版本支持的所有预编译合约指令，并从此版本开始同步支持EVM黄皮书中的新增指令；
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	// compress pub key(omnilink中需使用压缩格式)
