...
import (
	...
	vcomm "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/evm/executor/vm/common"
...
//value=500000000
//symbol=BTY
//token addr on omnilink evm=1111111111111111111114oLvT2
//omnilink sender=1Cj1rqUenPmkeD6A8MGEzkBKQFN2H9yL3x
