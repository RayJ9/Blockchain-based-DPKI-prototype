...
import (
	...
	pty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/pokerbull/types"
...
func testContinueRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
...
func testPlayRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
...
func testQuitRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
