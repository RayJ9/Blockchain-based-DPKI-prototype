...
func TestJRPCChannel(t *testing.T) {
	...
	testCases := []struct {
		fn func(*testing.T, *types.OmnilinkConfig, *jsonclient.JSONClient) error
	}{
...
func testPublishEventRawCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
	...
	var res string
	return jrpc.Call("Omnilink.CreateTransaction", params, &res)
}

func testAbortEventRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
...
func testPrePublishResultRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
...
func testAbortPrePubResultRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
	payload := &oty.EventAbort{EventID: "123"}
	params := &rpctypes.CreateTxIn{
		Execer:     cfg.ExecName(oty.OracleX),
...
func testPublishResultRawTxCmd(t *testing.T, cfg *types.OmnilinkConfig, jrpc *jsonclient.JSONClient) error {
	payload := &oty.ResultPrePublish{
		EventID: "123",
		Source:  "新浪体育",
		Result:  "{\"team1\":3, \"team2\":2}",
