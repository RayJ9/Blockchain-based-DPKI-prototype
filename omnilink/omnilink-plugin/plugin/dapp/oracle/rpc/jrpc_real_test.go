...
import (
	...
	oty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/oracle/types"
...
func createAllStatusEvent(t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock) {
	//total loop*5
...
func sendAddPublisher(t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock) {
	...
	var res string
	err := jrpcClient.Call("Omnilink.CreateTransaction", req, &res)
	assert.Nil(t, err)
...
func sendPublishEvent(t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock) (eventID string) {
...
func sendAbortPublishEvent(eventID string, t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock, expectErr error) {
	req := &rpctypes.CreateTxIn{
		Execer:     oty.OracleX,
...
func sendPrePublishResult(eventID string, t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock, expectErr error) {
	req := &rpctypes.CreateTxIn{
		Execer:     oty.OracleX,
...
func sendAbortPublishResult(eventID string, t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock, expectErr error) {
	req := &rpctypes.CreateTxIn{
		Execer:     oty.OracleX,
...
func sendPublishResult(eventID string, t *testing.T, jrpcClient *jsonclient.JSONClient, mocker *testnode.OmnilinkMock, expectErr error) {
	req := &rpctypes.CreateTxIn{
		Execer:     oty.OracleX,
...
func queryEventByeventID(eventID string, t *testing.T, jrpcClient *jsonclient.JSONClient, expectedStatus int32) {
	...
	err := jrpcClient.Call("Omnilink.Query", params, &resStatus)
	assert.Nil(t, err)
...
func queryEventByStatus(t *testing.T, jrpcClient *jsonclient.JSONClient) {
	for i := 1; i <= 5; i++ {
		...
		err := jrpcClient.Call("Omnilink.Query", params, &res)
		assert.Nil(t, err)
