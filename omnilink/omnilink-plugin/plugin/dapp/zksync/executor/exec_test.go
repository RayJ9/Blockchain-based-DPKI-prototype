...
import (
	...
	apimock "code.corp.bcollie.net/omnilink/omnilink-base/client/mocks"
	...
	"code.corp.bcollie.net/omnilink/omnilink-base/common/db"
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/zksync/wallet"
...
#二层的基于zk的omnilink地址，注意:非基于sep256k1的普通的omnilink地址，而是基于私钥产生的可用于二层的地址
layer2FeeAddr="2c4a5c378be2424fa7585320630eceba764833f1ec1ffb2fafc1af97f27baf5a"
`
	omnilinkTestCfg   = types.NewOmnilinkConfig(strings.Replace(cfgstring4execTest, "Title=\"local\"", "Title=\"omnilink\"", 1))
	zksyncHandle      *zksync
	dbHanleGlobal     db.DB
	index             = 0
	dbDir             = ""
...
func initSetup() {
	...
	accB := account.NewCoinsAccount(omnilinkTestCfg)
	accB.SetDB(kvdb)

	api := new(apimock.QueueProtocolAPI)
	api.On("GetConfig", mock.Anything).Return(omnilinkTestCfg, nil)
	driver := NewZksync()
	driver.SetAPI(api)
...
//++ docker exec build_omnilink_1 /root/omnilink-cli zksync l2addr -k 19c069234f9d3e61135fefbeb7791b149cdf6af536f26bebb310d4cd22c3fee4
//+ omnilinkAddr=2b8a83399ffc86cc88f0493f17c9698878dcf7caf0bf04a3a5321542a7a416d1

func TestOutputOmnilinkL2AddrDecimal(t *testing.T) {
	omnilinkAddrL2 := "2b8a83399ffc86cc88f0493f17c9698878dcf7caf0bf04a3a5321542a7a416d1"
	omnilinkAddrL2Decimal, _ := zksyncTypes.HexAddr2Decimal(omnilinkAddrL2)
	fmt.Println("omnilinkAddrL2Decimal=", omnilinkAddrL2Decimal)
...
func TestDeposit(t *testing.T) {
	...
	//12qyocayNF7Lv6C9qW4avxs2E7U41fKSfv
	managerPrivateKeySli, err := omnilinkCommon.FromHex("4257D8692EF7FE13C68B65D6A52F03933DB2FA5CE8FAF210B5B8B80C721CED01")
	assert.Nil(t, err)
...
func TestWithdraw(t *testing.T) {
	...
	//设置公钥
	acc1privkeySli, err := omnilinkCommon.FromHex("0x19c069234f9d3e61135fefbeb7791b149cdf6af536f26bebb310d4cd22c3fee4")
	assert.Nil(t, err)
	acc1privkey, err := driver.PrivKeyFromBytes(acc1privkeySli)
	assert.Nil(t, err)
	err = setPubKey(zksyncHandle, acc1privkey, accountID)
	assert.Nil(t, err)
	//leaf.OmnilinkAddr=2b8a83399ffc86cc88f0493f17c9698878dcf7caf0bf04a3a5321542a7a416d1
	//calcOmnilinkAddr= 19694183066356799104974294716313078444659172842638956126168373945465009608401
...
func TestTransfer(t *testing.T) {
	...
	toL2OmnilinkAddr := "2afff20cc3c20f9def369626463fb027ebeba0bd976025f68316bb8eab55d48c"
	//toAddrprivkey := "0x7a80a1f75d7360c6123c32a78ecf978c1ac55636f87892df38d8b85a9aeff115"
	receipt, _, err = transfer2New(zksyncHandle, acc1privkey, tokenId, accountID, "200", toEthAddr, toL2OmnilinkAddr)
	assert.Nil(t, err)
	assert.Equal(t, receipt.Ty, int32(types.ExecOk))
	assert.Greater(t, len(receipt.KV), 0)
	//继续发送交易
...
func TestTree2contract(t *testing.T) {
	...
	zkQueryReq := &zksyncTypes.ZkQueryReq{
		TokenSymbol:        symbol,
		OmnilinkWalletAddr: "1JRNjdEqp4LJ5fqycUBm9ayCKSeeskgMKR",
	}
...
func TestProxyExitFaid(t *testing.T) {
	...
	//设置公钥
	acc1privkeySli, err = omnilinkCommon.FromHex("0x9d4f8ab11361be596468b265cb66946c87873d4a119713fd0c3d8302eae0a8e4")
	assert.Nil(t, err)
	acc1privkey, err = driver.PrivKeyFromBytes(acc1privkeySli)
	assert.Nil(t, err)
...
func TestNFTMisc(t *testing.T) {
	...
	//设置公钥,给账户４
	acc4privkeySli, err := omnilinkCommon.FromHex("0x7a80a1f75d7360c6123c32a78ecf978c1ac55636f87892df38d8b85a9aeff115")
	assert.Nil(t, err)
...
func deposit(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, tokenId, queueId uint64, amount, ethAddress, omnilinkAddr string) (*types.Receipt, *types.LocalDBSet, error) {
	...
	tx := createOmnilinkTx(privateKey, action, zksyncTypes.Zksync, int64(1e8))
...
func setPubKey(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, accountId uint64) error {
...
func withdraw(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, accountID, tokenId uint64, amount string) (*types.Receipt, *types.LocalDBSet, error) {
...
func setTxFee(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, tokenId uint64, amount string, actionTy int32) (*types.Receipt, *types.LocalDBSet, error) {
...
func transfer(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, fromAccountId, toAccountId, tokenId uint64, amount string) (*types.Receipt, *types.LocalDBSet, error) {
...
func transfer2New(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, tokenId, fromAccountId uint64, amount, toEthAddress, toOmnilinkAddress string) (*types.Receipt, *types.LocalDBSet, error) {
	transfer2New := &zksyncTypes.ZkTransferToNew{
		TokenId:         tokenId,
		Amount:          amount,
		FromAccountId:   fromAccountId,
		ToEthAddress:    toEthAddress,
		ToLayer2Address: toOmnilinkAddress,
	}
...
func tree2contract(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, accountID, tokenId uint64, amount string) (*types.Receipt, *types.LocalDBSet, error) {
...
func setTokenSymbol(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, symbol, tokenID string, decimal uint32) (*types.Receipt, *types.LocalDBSet, error) {
...
func contract2tree(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, toAccountID uint64, symbol, amount string) (*types.Receipt, *types.LocalDBSet, error) {
...
func proxyExit(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, targetAccountID, proxyAccountID, tokenId uint64) (*types.Receipt, *types.LocalDBSet, error) {
...
func fullExit(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, accountID, tokenId, priorityQueueId uint64) (*types.Receipt, *types.LocalDBSet, error) {
...
func mintNFT(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, fromAccountId, recipientAccountId uint64, contentHash string) (*types.Receipt, *types.LocalDBSet, error) {
...
func withdrawNFT(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, fromAccountId, nftTokenId, amount uint64) (*types.Receipt, *types.LocalDBSet, error) {
...
func transferNFT(zksyncHandle *zksync, privateKey omnilinkCrypto.PrivKey, fromAccountId, recipientAccountId, ntTokenId, amount uint64) (*types.Receipt, *types.LocalDBSet, error) {
...
func createOmnilinkTx(privateKey omnilinkCrypto.PrivKey, action proto.Message, execer string, fee int64) *types.Transaction {
...
func SignTransaction(key omnilinkCrypto.PrivKey, tx *types.Transaction) (err error) {
