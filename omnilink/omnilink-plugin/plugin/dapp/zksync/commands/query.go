...
func queryAccountCmd() *cobra.Command {
	...
	cmd.AddCommand(getAccountByOmnilinkCmd())
...
func getMaxAccountId(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Omnilink.Query", params, &resp)
	ctx.Run()
}
...
func getAccountByOmnilinkCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "accountC",
		Short: "get zksync account by omnilinkAddr",
		Run:   getAccountByOmnilink,
	}
	getAccountByOmnilinkFlag(cmd)
	return cmd
}

func getAccountByOmnilinkFlag(cmd *cobra.Command) {
	cmd.Flags().StringP("omnilinkAddr", "c", "", "zksync account omnilinkAddr")
	cmd.MarkFlagRequired("omnilinkAddr")
}

func getAccountByOmnilink(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	...
	params.FuncName = "GetAccountByOmnilink"
	params.Payload = types.MustPBToJSON(req)
...
func getContractAccountCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "contractAccount",
		Short: "get zksync contractAccount by omnilinkWalletAddr and token symbol",
...
func getContractAccountFlag(cmd *cobra.Command) {
	cmd.Flags().StringP("omnilinkAddr", "c", "", "omnilink wallet address")
	cmd.MarkFlagRequired("omnilinkAddr")
...
func getContractAccount(cmd *cobra.Command, args []string) {
	...
	req := &zt.ZkQueryReq{
		TokenSymbol:        token,
		OmnilinkWalletAddr: omnilinkAddr,
	}
