...
import (
	...
	//"gitlab.33.cn/zkrelayer/relayer/omnilink/calcwitness"
	//"gitlab.33.cn/zkrelayer/relayer/common"
	omnilinkTy "code.corp.bcollie.net/omnilink/omnilink-base/types"
...
func NewMainChainClient(paraRemoteGrpcClient string) omnilinkTy.OmnilinkClient {
	...
	grpcClient := omnilinkTy.NewOmnilinkClient(conn)
	return grpcClient
}

//该命令用于从区块链获取包含l2交易的区块
//./omnilink-cli zksync sendl2 fetch -s 800 -e 6015 -p . --rpc_laddr 172.18.0.6:8902
