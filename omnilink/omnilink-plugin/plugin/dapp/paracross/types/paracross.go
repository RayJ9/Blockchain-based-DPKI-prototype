...
func CreateRawCommitTx4MainChain(cfg *types.OmnilinkConfig, status *ParacrossCommitAction, name string, fee int64) (*types.Transaction, error) {
	return createRawCommitTx(cfg, status, name, fee)
}

func createRawCommitTx(cfg *types.OmnilinkConfig, commit *ParacrossCommitAction, name string, feeRate int64) (*types.Transaction, error) {
...
func CreateRawAssetTransferTx(cfg *types.OmnilinkConfig, param *types.CreateTx) (*types.Transaction, error) {
...
func CreateRawMinerTx(cfg *types.OmnilinkConfig, value *ParacrossMinerAction) (*types.Transaction, error) {
...
func GetDappForkHeight(cfg *types.OmnilinkConfig, forkKey string) int64 {
...
func IsParaForkHeight(cfg *types.OmnilinkConfig, height int64, forkKey string) bool {
