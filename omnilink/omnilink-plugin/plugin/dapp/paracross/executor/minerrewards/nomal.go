...
//获取配置的奖励数值
func (n *normal) GetConfigReward(cfg *types.OmnilinkConfig, height int64) (int64, int64, int64) {
...
//奖励矿工算法
func (n *normal) RewardMiners(cfg *types.OmnilinkConfig, coinReward int64, miners []string, height int64) ([]*pt.ParaMinerReward, int64) {
	//找零
	var change int64
