...
func NewParaAccount(cfg *types.OmnilinkConfig, paraTitle, mainExecName, mainSymbol string, db db.KV) (*account.DB, error) {
...
func NewMainAccount(cfg *types.OmnilinkConfig, paraTitle, paraExecName, paraSymbol string, db db.KV) (*account.DB, error) {
