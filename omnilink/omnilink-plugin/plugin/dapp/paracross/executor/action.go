...
func validTitle(cfg *types.OmnilinkConfig, title string) bool {
	if cfg.IsPara() {
...
func checkCommitInfo(cfg *types.OmnilinkConfig, commit *pt.ParacrossNodeStatus) error {
	if commit == nil {
...
func makeDoneReceipt(cfg *types.OmnilinkConfig, execMainHeight, execHeight int64, commit *pt.ParacrossNodeStatus,
...
func paraCheckSelfConsOn(cfg *types.OmnilinkConfig, db dbm.KV, commit *pt.ParacrossNodeStatus) (bool, *types.Receipt, error) {
...
func isHaveCrossTxs(cfg *types.OmnilinkConfig, status *pt.ParacrossNodeStatus) bool {
...
func (a *action) assetTransferMainCheck(cfg *types.OmnilinkConfig, transfer *types.AssetsTransfer) error {
...
func (a *action) assetWithdrawMainCheck(cfg *types.OmnilinkConfig, withdraw *types.AssetsWithdraw) error {
