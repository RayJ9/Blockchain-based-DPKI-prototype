...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/relay/cmd/relayd/relayd"
)

var (
	cpuNum             = runtime.NumCPU()
	configPath         = flag.String("f", "relayd.toml", "configfile")
	OmnilinkConfigPath = flag.String("omnilinkflie", "", "OmnilinkConfigfile")
)
...
func main() {
	...
	if *OmnilinkConfigPath != "" {
		cfg.OmnilinkCfg = types.NewOmnilinkConfig(types.ReadFile(OmnilinkConfigigPath))
	}
