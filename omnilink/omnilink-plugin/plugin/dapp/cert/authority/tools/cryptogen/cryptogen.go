...
import (
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cert/authority/tools/cryptogen/generator"
	"github.com/spf13/cobra"
)

const (
	// CONFIGFILENAME 配置文件名
	CONFIGFILENAME = "omnilink.cryptogen.yaml"
	// OUTPUTDIR 证书文件输出路径
...
var (
	cmd = &cobra.Command{
		...
		Short: "omnilink crypto tool for generating key and certificate",
		Run:   generate,
	}
