...
import (
	...
	ecdsa_util "code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/secp256r1"
	sm2_util "code.corp.bcollie.net/omnilink/omnilink-base/system/crypto/sm2"
