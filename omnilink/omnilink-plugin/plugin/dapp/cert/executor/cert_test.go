...
import (
	...
	pty "code.corp.bcollie.net/omnilink/omnilink-base/system/dapp/manage/types"
	"code.corp.bcollie.net/omnilink/omnilink-base/types"
	"code.corp.bcollie.net/omnilink/omnilink-base/util"
	_ "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/crypto/init"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cert/authority"
	"code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cert/authority/utils"
	ct "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/cert/types"
	pkt "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/collateralize/types"
...
func initEnv() (*execEnv, error) {
	cfg := types.NewOmnilinkConfig(types.ReadFile("./test/omnilink.auth.test.toml"))
	cfg.SetTitleOnlyForTest("omnilink")
