...
import (
	...
	ca "code.corp.bcollie.net/omnilink/omnilink-base/system/dapp/coins/autotest"
	ta "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/token/autotest"
)
