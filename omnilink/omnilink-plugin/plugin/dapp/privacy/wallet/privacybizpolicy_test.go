...
import (
	...
	ty "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/privacy/types"

	privacy "code.corp.bcollie.net/omnilink/omnilink-plugin/plugin/dapp/privacy/wallet"
