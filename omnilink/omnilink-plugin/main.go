...
import (
	...
	frameVersion "code.corp.bcollie.net/omnilink/omnilink-base/common/version"
	...
	"code.corp.bcollie.net/omnilink/omnilink-plugin/version"
)
...
func main() {
	...
	if *versionCmd {
		...
		fmt.Fprintln(os.Stdout, "omnilink frame version:", frameVersion.GetVersion())
		return
	}
	cli.RunOmnilink("", "")
}
