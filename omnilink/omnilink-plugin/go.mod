module code.corp.bcollie.net/omnilink/omnilink-plugin

go 1.19

require (
	code.corp.bcollie.net/omnilink/omnilink-base v1.68.2
...
replace code.corp.bcollie.net/omnilink/omnilink-base v1.68.2 => ../omnilink-base
