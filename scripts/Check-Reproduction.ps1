...
$RequiredPaths = @(
    ...
    "blockchain\.internal\old-ver-simulations\simu2-8-packaged\real_figure_sweep_common.py",
    "blockchain\.internal\old-ver-simulations\simu2_tail_prob\real_sweep_figures.py",
