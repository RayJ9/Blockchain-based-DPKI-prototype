...
$RequiredPaths = @(
    ...
    "platforms\centralized-pki\index.js",
    "platforms\centralized-pki\platform.json",
    "platforms\proposed-dpki\index.js",
    "platforms\proposed-dpki\contracts\ProposedDPKI.sol",
    "platforms\multi-ca-dpki\index.js",
    "platforms\multi-ca-dpki\contracts\ThresholdValidationDPKI.sol",
    "platforms\full-contract-dpki\index.js",
    "platforms\full-contract-dpki\contracts\FullContractDPKI.sol",
    "sidechain-three-chain-prototype\run_experiment.ps1",
    "sidechain-three-chain-prototype\run-sidechain-smoke.js",
    "sidechain-three-chain-prototype\scripts\start-three-chains.ps1",
