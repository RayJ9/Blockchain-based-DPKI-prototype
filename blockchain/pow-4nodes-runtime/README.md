...
```powershell
.\blockchain\pow-4nodes-runtime\scripts\start-omnilink-pow-4nodes.ps1 -Build -Clean -MeanBlockMs 200
node .\blockchain\dpki-experiment\run-real-dpki-experiment.js --consensus-backend pow --rpc http://127.0.0.1:8545
